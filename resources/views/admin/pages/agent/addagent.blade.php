                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Establishment Date:
                                            <input type="date" name="establishment_date" value="{{ old('establishment_date') }}" class="form-control">
                                        </label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Licence Expire Date:
                                            <input type="date" name="licence_exp_date" value="{{ old('licence_exp_date') }}" class="form-control">
                                        </label>
