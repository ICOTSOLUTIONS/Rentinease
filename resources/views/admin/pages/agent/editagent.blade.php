        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card design">
                    <form action="{{ route('agent.update',['agent'=>$agent->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                        ...
                                        <label>Agent Type
                                            <select name = "agent_type" class="form-control w-110">
                                                ...
                                                <option value = "brokerage"
                                                    @if(old('agent_type') == "brokerage" || $agent->type == "brokerage")
                                                        value = "{{ $agent->type }}" selected
                                                    @else
                                                        value = "{{ $agent->type }}"
                                                    @endif >Brokerage</option>
                                                <option value = "sales_marketing"
                                                    @if(old('agent_type') == "sales_marketing" || $agent->type == "sales_marketing")
                                                        value = "{{ $agent->type }}" selected
                                                        @else
                                                        value = "{{ $agent->type }}" 
                                                    @endif >Sales&Marketing</option>
                                                <option value = "professional_services"
                                                     @if(old('agent_type') == "professional_services" || $agent->type == "professional_services")
                                                        value = "{{ $agent->type }}" selected
                                                    @else
                                                        value = "{{ $agent->type }}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Establishment Date:
                                            ...
                                            @else
                                            value="{{ $agent->establishment_date }}" 
                                            @endif />
                                        </label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group justify-content-center">
                                        <label class="">Autorised
                                            <br>
                                            <input type="checkbox" class="" value="{{ $agent->authorised }}">
                                        </label>
                                    </div>
                                </div>
                            </div>
