                    ...
                    <form action="{{ route('agency.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Company Type
                                            <select name="company_type" id="" class="form-control w-100">
                                                ...
                                                <option value="property_management" @if (old('company_type')=='Property-Management' ) selected @endif>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="w-100">Packages
                                        <select class="form-control w-100" name="package" id="package">
                            ...
                            {{-- <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Access of Agents
