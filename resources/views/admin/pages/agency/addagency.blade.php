                            ...
                            <div class="card-body">
                                            ...
                                            <label>Company Type
                                                <select name="company_type" id="" class="form-control w-110">
                                                    ...
                                                    <option value="realstate"
                                                        @if (old('company_type') == 'RealState') selected @endif>RealState</option>
                                                    <option value="developer"
                                                        @if (old('company_type') == 'Developer') selected @endif>Developer</option>
                                                    ...
                                                    <option value="lending"
                                                        @if (old('company_type') == 'Lending') selected @endif>Lending</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Owner EID
                                                <input type="file" name="owner_eid" value="{{ old('owner_eid') }}"
                                                    class="form-control">
                                            </label>
                                            @error('owner_eid')
                                                <div class="text-danger">{{ $message }}</div>
