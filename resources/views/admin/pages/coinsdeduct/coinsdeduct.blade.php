                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-evenly">
                                                    <a href="{{ route('coinsdeduct.edit', ['coinsdeduct' => $coins_deduct->id]) }}" class="btn btn-success text-white"><i class="fas fa-edit"></i></a>
                                                    <form action="{{ route('coinsdeduct.destroy', ['coinsdeduct' => $coins_deduct->id]) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
