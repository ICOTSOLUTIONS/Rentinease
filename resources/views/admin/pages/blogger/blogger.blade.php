                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-around">
                                                    <a href="{{ route('blogger.show',['blogger'=>$blogger->id]) }}" class="btn btn-info text-white"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route('blogger.edit', ['blogger' => $blogger->id]) }}" class="btn btn-success text-white"><i class="fas fa-edit"></i></a>
                                                    <form action="{{ route('blogger.destroy', ['blogger' => $blogger->id]) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
