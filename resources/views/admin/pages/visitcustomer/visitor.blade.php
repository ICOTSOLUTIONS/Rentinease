                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-around">
                                                    <a href="{{ route('customer.show',['customer'=>$customer->id]) }}" class="btn btn-info text-white"><i class="fas fa-eye"></i></a>
                                                    <a href="{{ route('customer.edit',['customer'=>$customer->id]) }}" class="btn btn-success text-white"><i class="fas fa-edit"></i></a>
