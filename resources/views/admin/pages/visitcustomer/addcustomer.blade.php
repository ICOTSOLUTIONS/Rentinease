                    ...
                    <form action="{{ route('customer.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Rera no
                                            <input type="text" class="form-control" name="rera_no" value="{{ old('rera_no') }}">
                                        </label>
                                        @error('rera_no')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Country
                                            <input type="text" class="form-control" name="country" value="UAE" readonly>
                                        </label>
                                        @error('country')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-3">
                                    <div class="form-group justify-content-center">
                                        <label class="w-100" class="">Autorised
                                            <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Profile Logo
