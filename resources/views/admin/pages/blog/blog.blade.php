                            ...
                            <table class="table table-striped" id="table-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (!empty($blog->image))
                                            <img width="100" height="100" src="{{ asset('/storage/blog/' . $blog->image) }}" class="img-fluid wp-post-image lazyloaded" alt="" loading="lazy" />
                                            @else
                                            <img width="100" height="100" src="https://www.comparethestorage.com/blog/wp-content/uploads/2019/06/writing-man-person-hair-white-thinking-1169800-pxhere.com_-1120x747.jpg" class="img-fluid wp-post-image lazyloaded" alt="" loading="lazy" />
                                            @endif
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('blog.statusChange', ['id' => $blog->id]) }}" class="btn btn-success text-white">Active</a>
                                            @else
                                            <a href="{{ route('blog.statusChange', ['id' => $blog->id]) }}" class="btn btn-danger text-white">De-Active</a>
                                            @endif
                                        </td>
                                        @if (auth()->user()->roles->name != 'subadmin')
                                        <td>
                                            <div class="row">
                                                <div class="col-md-12 d-flex justify-content-around">
                                                    <a href="{{ route('blog.edit', ['blog' => $blog->id]) }}" class="btn btn-success text-white"><i class="fas fa-edit"></i></a>
