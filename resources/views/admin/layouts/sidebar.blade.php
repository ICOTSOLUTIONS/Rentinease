  ...
  <aside id="sidebar-wrapper">
    ...
    <div class="sidebar-user">
      <div class="sidebar-user-picture">
        <img alt="image" src="{{ asset('assets/img/myimg.jpg') }}">
      </div>
    ...
    <ul class="sidebar-menu">
      ...
      <li class="nav-link has-dropdown"><a href="{{ route('admin.dashboard') }}"><i data-feather="monitor"></i><span>Dashboard</span></a></li>
      ...
      @endif
      <li class="nav-link has-dropdown"><a href="{{ route('package.index') }}"><i data-feather="box"></i><span>Package</span></a></li>
      <li class="nav-link has-dropdown"><a href="{{ route('activity.index') }}"><i data-feather="activity"></i><span>Activity Logs</span></a></li>
      <li class="nav-link has-dropdown"><a href="{{ route('coinsdeduct.index') }}"><i data-feather="activity"></i><span>Coins Deduction</span></a></li>
      @endif
      @if (auth()->user()->roles->name == 'admin' || auth()->user()->roles->name == 'blogger')
      <li class="nav-link has-dropdown"><a href="{{ route('blog.index') }}"><i data-feather="bold"></i><span>Blog</span></a></li>
      @endif
      <!-- <li class="dropdown">
