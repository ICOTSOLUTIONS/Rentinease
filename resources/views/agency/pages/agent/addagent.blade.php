    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="{{ route('agencyAgents.store') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <label>Agent Type
                                                <select name="agent_type" id="" class="form-control w-110">
                                                    ...
                                                    <option value="brokerage" <blade
                                                        if|%20(old(%26%2339%3Bcompany_type%26%2339%3B)%20%3D%3D%20%26%2339%3BBrokerage%26%2339%3B)%20selected%20%40endif%3EBrokerage%0D>
                                                    </option>
                                                    <option value="sales_marketing" <blade
                                                        if|%20(old(%26%2339%3Bcompany_type%26%2339%3B)%20%3D%3D%20%26%2339%3BSales%26Marketing%26%2339%3B)%20selected%20%40endif%3E%0D>
                                                        Sales&Marketing
                                                    </option>
                                                    <option value="professional_services" <blade
                                                        if|%20(old(%26%2339%3Bcompany_type%26%2339%3B)%20%3D%3D%20%26%2339%3BProfessional%20Services%26%2339%3B)%20selected%20%40endif%3EProfessional%0D>
                                                        Services</option>
                                                </select>
                                            </label>
                                            @error('agent_type')
                            ...
                            <div class="row"> --}}
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Rera no
                                                <input type="text" name="rera_no"
                                                    value="{{ old('rera_no') }}" class="form-control">
                                            </label>
                                            @error('rera_no')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            <label>Office
                                                <input type="text" name="office"
                                                    value="{{ old('office') }}" class="form-control">
                                            </label>
                                            @error('office')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
...
@if(old('package'))
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Agent EID
                            <input type="file" name="agent_eid" value="{{ old('agent_eid') }}"
                                class="form-control">
                        </label>
                        @error('agent_eid')
                            <div class="text-danger">{{ $message }}</div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>Agent Visa
                            <input type="file" name="agent_visa" value="{{ old('agent_visa') }}"
                                class="form-control">
                        </label>
                        @error('agent_visa')
                            <div class="text-danger">{{ $message }}</div>
