                                    ...
                                    <div class="form-group">
                                        <label class="w-100">Agent Type
                                            <select name="agent_type" id="" class="form-control w-100">
                                                ...
                                                <option value="brokerage" @if (old('company_type')=='Brokerage' ) selected @endif>Brokerage
                                                </option>
                                                <option value="sales_marketing" @if (old('company_type')=='Sales&Marketing' ) selected @endif>
                                                    Sales&Marketing
                                                </option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Establishment Date:
                                            <input type="date" name="establishment_date" value="{{ old('establishment_date') }}" class="form-control w-100">
                                        </label>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="w-100">Licence Expire Date:
                                            <input type="date" name="licence_exp_date" value="{{ old('licence_exp_date') }}" class="form-control w-100">
                                        </label>
