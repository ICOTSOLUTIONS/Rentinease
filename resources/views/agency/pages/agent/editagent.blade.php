                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card design">
                            <form action="{{ route('agency.agent.update', ['agent' => $agent->id]) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <label>Agent EID
                                                    <input type="file" name="agent_eid"
                                                        value="{{ $agent->agent_eid }}" class="form-control">
                                                </label>
                                                @error('agent_eid')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label>Agent Visa
                                                    <input type="file" name="agent_visa"
                                                        value="{{ $agent->agent_visa }}" class="form-control">
                                                </label>
                                                @error('agent_visa')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label>Additional Documents
                                                    <input type="file" name="additional_documents"
                                                        value="{{ $agent->additional_documents }}"
                                                        class="form-control">
                                                </label>
