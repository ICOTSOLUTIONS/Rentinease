                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <a href="{{ route('agency.agent.edit', ['agent' => $agent->id]) }}" class="btn btn-info text-white">Edit</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <a href="{{ route('agency.agent.show', ['agent' => $agent->id]) }}" class="btn btn-info text-white">View</a>
                                                </div>
                                                <div class="col-md-4">
                                                    <form action="{{ route('agency.agent.destroy', ['agent' => $agent->id]) }}" method="POST">
                                                        @method('DELETE')
                                                        @csrf
