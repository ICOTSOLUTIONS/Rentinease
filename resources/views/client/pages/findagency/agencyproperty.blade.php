                ...
                <div class="property_block_wraps">
                    <div class="property_block_wrap_header">
                        <ul class="nav nav-pills tabs_system" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="pills-property-tab" data-toggle="pill" href="#pills-property"
                                    role="tab" aria-controls="pills-property" aria-selected="true">Properties</a>
                            </li>
                            <li class="nav-item">
                                                ...
                                                <div class="listing-img-wrapper">
                                                    ...
                                                    <div class="list-img-slide">
                                                        <div class="click">
                                                            ...
                                                            <div><a href="single-property-1.html"><img
                                                                        src="{{ asset('assetsclient/img/p-2.png') }}"
                                                                        class="img-fluid mx-auto" alt="" /></a>
                                                            </div>
                                                            <div><a href="single-property-1.html"><img
                                                                        src="{{ asset('assetsclient/img/p-3.png') }}"
                                                                        class="img-fluid mx-auto" alt="" /></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="listing-detail-footer">
                                                    <div class="footer-first">
                                                        <div class="foot-location"><img src="assets/img/pin.svg"
                                                                width="18" alt="" />Montreal, Canada</div>
                                                    </div>
                                                ...
                                                <div class="grid_agents-wrap">
                                                    ...
                                                    <div class="fr-grid-deatil">
                                                        ...
                                                        <h5 class="fr-can-name"><a
                                                                href="{{ url('/agentproperty') }}">ADNAN</a></h5>
                                                    ...
                                                    <div class="fr-infos-deatil">
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#autho-message" class="btn agent-btn theme-bg"><i
