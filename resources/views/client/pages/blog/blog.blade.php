                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="grid_blog_box">
                            ...
                            <div class="gtid_blog_thumb">
                                <a href="blog-detail.html"><img src="{{ asset('storage/blog/' . $blog->image) }}"
                            ...
                            <div class="blog-body">
                                <h4 class="bl-title"><a
                                        href="{{ route('web.blog.details', ['id' => $blog->id]) }}">{{ $blog->heading }}</a>
                                </h4>
                                    ...
                                    <div class="property-author">
                                        @if ($blog->user->role_id == 1)
                                            <div class="path-img"><a href="agent-page.html" tabindex="-1"><img
                                                        src="{{ asset('storage/admin/' . $blog->user->logo) }}"
                                                        class="img-fluid" alt=""></a></div>
                                        @else
                                            <div class="path-img"><a href="agent-page.html" tabindex="-1"><img
                                                        src="{{ asset('storage/blogger/' . $blog->user->logo) }}"
                                                        class="img-fluid" alt=""></a></div>
                                        @endif
                                        <h5><a href="agent-page.html"
                                                tabindex="-1">{{ $blog->user->fname . ' ' . $blog->user->lname }}</a></h5>
                                    </div>
