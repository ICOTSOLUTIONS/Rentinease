        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 ">
                ...
                <div class="breadcrumbs-wrap mt-5">
                    ...
                    <h2 class="breadcrumb-title text-center">Rentinease Real Estate - Dubai</h2>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-3 col-sm-12">
                            <div class="form-group none">
                                <a class="collapsed ad-search" data-toggle="collapse" data-parent="#search" data-target="#advance-search" href="javascript:void(0);" aria-expanded="false" aria-controls="advance-search"><i class="fa fa-sliders-h mr-2"></i>Advance
                                    Filter</a>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <div class="simple-input">
                                    <select id="price" class="form-control">
                                        <option value="">&nbsp;</option>
                                        <option value="1">Less Then AED 1000</option>
                                        <option value="2">AED 1000 - AED 2000</option>
                                        <option value="3">AED 2000 - AED 3000</option>
                                        <option value="4">AED 3000 - AED 4000</option>
                                        <option value="5">Above AED 5000</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="property-listing list_view">
                            ...
                            <div class="listing-img-wrapper">
                                <div class="_exlio_125">VERIFIED</div>
                                    ...
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 7,000</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
                                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">5689 Resot Relly Market, Bur Dubai
                                                        Dubai, HAQC445</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing-detail-wrapper mt-1">
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 10,500</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
                                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">9632 New Green Garden, Bur Dubai
                                                        Dubai, AWE789O</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing-detail-wrapper mt-1">
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 8,700</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
                                                <h4 class="listing-name verified"><a href="single-property-1.html" class="prt-link-detail">8512 Red Reveals Market, Bur Dubai
                                                        Dubai, SHQT45O</a></h4>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="listing-detail-wrapper mt-1">
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 9,100</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
                                ...
                                <div class="listing-detail-wrapper mt-1">
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 7,400</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
                                ...
                                <div class="listing-detail-wrapper mt-1">
                                    <div class="listing-short-detail-wrap">
                                        <div class="_card_list_flex mb-2">
                                            ...
                                            <div class="_card_flex_last">
                                                <h6 class="listing-card-info-price mb-0">AED 9,700</h6>
                                            </div>
                                        </div>
                                        <div class="_card_list_flex">
                                            <div class="_card_flex_01">
