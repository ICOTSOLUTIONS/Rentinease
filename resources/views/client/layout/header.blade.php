          ...
          <div class="row">
              ...
              <nav id="navigation" class="navigation navigation-landscape">
                  ...
                  <div class="nav-header col-md-2">
                      ...
                      <span class="nav-brand static-logo w-100"><img class=""
                              src="{{ asset('assets/img/logo_white.png') }}" alt="" srcset=""></span>
                      <span class="nav-brand fixed-logo w-100"><img class=""
                              src="{{ asset('assets/img/logo_blue.png') }}" alt="" srcset=""></span>
                  ...
                  <div class="col-md-12">
                      ...
                      <div class="nav-menus-wrapper row" style="transition-property: none;">
                          <div class="col-md-8">
                              ...
                              <ul class="nav-menu">
                                  ...
                                  <li><a href="#">Agent<span class="submenu-indicator"></span></a>
                                      <ul class="nav-dropdown nav-submenu">
                                          <li><a href="{{ route('web.findagent') }}">Find Agent<span
                                                      class="submenu-indicator"></span></a>
                                          </li>
                                  ...
                                  <li><a href="{{ route('web.blog') }}">Blog<span
                                              class="submenu-indicator"></span></a>
                                  </li>
                                  <li><a href="{{ url('') }}">New Projects<span
                                              class="submenu-indicator"></span></a>
                                  </li>
                                  <!-- <li><a href="{{ url('') }}">Make It (Off Plan)<span class="submenu-indicator"></span></a>
                                        </li> -->
                                  <li><a href="{{ url('/contact') }}">Contact<span
                                              class="submenu-indicator"></span></a>
                                  </li>
                              </ul>
                          ...
                          <div class="col-md-4">
                              ...
                              <ul class="nav-menu nav-menu-social d-flex justify-content-around">
