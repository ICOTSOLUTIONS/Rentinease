!(function (e, t) {
    ...
    var p = (function (n) {
        ...
        try {
            z.apply((t = P.call(x.childNodes)), x.childNodes),
        ...
        function ae(e, t, n, i) {
            ...
            if (!i && (_(t), (t = t || S), T)) {
                ...
                if (
                    ...
                    if (
                        ((u = e), (h = t), 1 === d && (G.test(e) || U.test(e)))
                    ) {
                        for (
                            ((h = (ne.test(e) && me(t.parentNode)) || t) ===
                                t &&
                                p.scope) ||
                                ((a = t.getAttribute("id"))
                                    ? (a = a.replace(re, oe))
            ...
            function (e) {
                ...
                return (
                    i != S &&
                        ...
                        (u = []),
                        (g = []),
                        (p.qsa = ee.test(S.querySelectorAll)) &&
                            (ue(function (e) {
                                var t;
        ...
        (ae.contains = function (e, t) {
            return (e.ownerDocument || e) != S && _(e), v(e, t);
        }),
        ...
        function we(e) {
            for (
                ...
                if ((t = b.relative[e[a].type])) u = [ve(xe(u), t)];
                else {
                    if (
                        (t = b.filter[e[a].type].apply(null, e[a].matches))[k]
                    ) {
                        ...
                        return (function e(p, f, m, g, y, t) {
                            return (
                                ...
                                ce(function (e, t, n, i) {
                                    ...
                                    } else (d = be(d === t ? d.splice(c, d.length) : d)), y ? y(null, t, d, i) : z.apply(t, d);
                                })
                            );
                        })(
                            1 < a && xe(u),
        ...
        return (
            ...
            (f = ae.tokenize =
                function (e, t) {
                    ...
                    return t ? s.length : s ? ae.error(e) : C(e, a).slice(0);
                }),
            (d = ae.compile =
                function (e, t) {
                    var n,
                    ...
                    if (((n = n || []), 1 === u.length)) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                (i = l(
                                    s.matches[0].replace(ie, h),
                                    (ne.test(o[0].type) && me(t.parentNode)) ||
                                        t
                                ))
                            ) {
            ...
            (p.sortStable = k.split("").sort(A).join("") === k),
    ...
    (k.filter = function (e, t, n) {
        ...
        k.fn.extend({
            ...
            is: function (e) {
                return !!D(
                    this,
                    "string" == typeof e && E.test(e) ? k(e) : e || [],
                    !1
                ).length;
            },
        });
            ...
            function (i, r) {
                k.fn[i] = function (e, t) {
                    ...
                    return (
                        ...
                        1 < this.length &&
                            (L[i] || k.uniqueSort(n), N.test(i) && n.reverse()),
                        this.pushStack(n)
                    );
                };
            }
    ...
    (k.Callbacks = function (i) {
        ...
        k.extend({
                    ...
                    s = {
                        ...
                        then: function (t, n, i) {
                            ...
                            return k
                                .Deferred(function (e) {
                                    o[0][3].add(
                                        c(0, e, x(i) ? i : P, e.notifyWith)
                                    ),
                                        o[1][3].add(c(0, e, x(t) ? t : P)),
                                        o[2][3].add(c(0, e, x(n) ? n : H));
                                })
                                .promise();
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (
                    n <= 1 &&
                    (I(e, s.done(t(i)).resolve, s.reject, !n),
    ...
    function U(e) {
        return e.replace(W, "ms-").replace(V, B);
    }
    function G(e) {
    ...
    function se(e, t) {
        return (
            ...
            ("" === e.style.display && re(e) && "none" === k.css(e, "display"))
        );
    }
    function ae(e, t, n, i) {
        var r,
    ...
    var ue,
        ...
        fe = T.createDocumentFragment().appendChild(T.createElement("div"));
    ...
    function ge(e, t) {
        var n =
            void 0 !== e.getElementsByTagName
                ...
                : [];
        return void 0 === t || (t && M(e, t)) ? k.merge([e], n) : n;
    }
    function ye(e, t) {
        for (var n = 0, i = e.length; n < i; n++)
    ...
    function Me(e, r, o) {
        o
              ...
              k.event.add(e, r, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[r]) {
                          if (i.length)
                              (k.event.special[r] || {}).delegateType &&
                                  e.stopPropagation();
                          else if (
                              ((i = a.call(arguments)),
                              $.set(this, r, i),
            ...
            : void 0 === $.get(e, r) && k.event.add(e, r, Se);
    }
    (k.event = {
        global: {},
                ...
                for (c = (t = (t || "").match(z) || [""]).length; c--; )
                    if (
                        ...
                        s &&
                            !d.length &&
                            ((h.teardown &&
                                !1 !== h.teardown.call(e, f, g.handle)) ||
                                k.removeEvent(e, p, g.handle),
                            delete l[p]);
                    } else for (p in l) k.event.remove(e, p + t[c], n, i, !0);
                k.isEmptyObject(l) && $.remove(e, "handle events");
            }
        },
        dispatch: function (e) {
            var t,
                ...
                l = k.event.fix(e),
                c =
                    ($.get(this, "events") || Object.create(null))[l.type] ||
                    [],
    ...
    function je(e, t) {
        var n, i, r, o, s, a;
        if (1 === t.nodeType) {
            if ($.hasData(e) && (a = $.get(e).events))
                for (r in ($.remove(t, "handle events"), a))
    ...
    function ze(n, i, r, o) {
        ...
        var e,
            ...
            p = i[0],
            f = x(p);
        if (f || (1 < h && "string" == typeof p && !v.checkClone && De.test(p)))
            return n.each(function (e) {
                var t = n.eq(e);
                f && (i[0] = p.call(this, e, t.html())), ze(t, i, r, o);
            });
        if (
            h &&
            ((t = (e = xe(i, n[0].ownerDocument, !1, n, o)).firstChild),
            1 === e.childNodes.length && (e = t),
            t || o)
        ) {
            for (a = (s = k.map(ge(e, "script"), Ne)).length; u < h; u++)
                (l = e),
                    u !== d &&
                        ((l = k.clone(l, !0, !0)),
                        a && k.merge(s, ge(l, "script"))),
                    r.call(n[u], l, u);
            if (a)
                for (
                    c = s[s.length - 1].ownerDocument, k.map(s, Le), u = 0;
                    u < a;
                    u++
                )
                    (l = s[u]),
                        pe.test(l.type || "") &&
                            ...
                            (l.src && "module" !== (l.type || "").toLowerCase()
                                ...
                                : b(l.textContent.replace(Oe, ""), l, c));
        }
        return n;
    }
    function Pe(e, t, n) {
    ...
    function Ze() {
        ...
        Be &&
            ...
            ie.appendChild(Ve).appendChild(Be),
            (e = S.getComputedStyle(Be)),
            (Ie = "1%" !== e.top),
            (We = 12 === Ke(e.marginLeft)),
            (Be.style.right = "60%"),
            (qe = 36 === Ke(e.right)),
            (Ye = 36 === Ke(e.width)),
            (Be.style.position = "absolute"),
            (Re = 12 === Ke(Be.offsetWidth / 3)),
            ie.removeChild(Ve),
            (Be = null));
    }
    function Ke(e) {
    ...
    function lt(e, t, n, i, r, o) {
        ...
        for (; s < 4; s += 2)
            "margin" === n && (l += k.css(e, n + ne[s], !0, r)),
                i
                    ? ("content" === n &&
                          (l -= k.css(e, "padding" + ne[s], !0, r)),
                      "margin" !== n &&
                          (l -= k.css(e, "border" + ne[s] + "Width", !0, r)))
                    : ((l += k.css(e, "padding" + ne[s], !0, r)),
                      "padding" !== n
                          ? (l += k.css(e, "border" + ne[s] + "Width", !0, r))
                          : (a += k.css(e, "border" + ne[s] + "Width", !0, r)));
        return (
            !i &&
                0 <= o &&
                (l +=
    ...
    k.extend({
        ...
        k.each({ margin: "", padding: "", border: "Width" }, function (r, o) {
            (k.cssHooks[r + o] = {
                ...
                "margin" !== r && (k.cssHooks[r + o].set = at);
        }),
        k.fn.extend({
            css: function (e, t) {
                return F(
    ...
    function yt() {
        dt &&
            (!1 === T.hidden && S.requestAnimationFrame
                ? S.requestAnimationFrame(yt)
                : S.setTimeout(yt, k.fx.interval),
            k.fx.tick());
    }
    function vt() {
        return (
    ...
    function wt(o, e, t) {
        ...
        for (
            ...
            if ((n = wt.prefilters[i].call(c, o, u, c.opts)))
                return (
                    x(n.stop) &&
                        (k._queueHooks(c.elem, c.opts.queue).stop =
                            n.stop.bind(n)),
                    n
                );
        return (
    ...
    (k.Animation = k.extend(wt, {
        ...
        (ft = T.createElement("select").appendChild(T.createElement("option"))),
        (pt.type = "checkbox"),
        (v.checkOn = "" !== pt.value),
        (v.optSelected = ft.selected),
        ((pt = T.createElement("input")).value = "t"),
        (pt.type = "radio"),
        (v.radioValue = "t" === pt.value);
    var _t,
                    ...
                    return void 0 === e.getAttribute
                        ...
                        : ((1 === o && k.isXMLDoc(e)) ||
                              (r =
                                  ...
                                  (k.expr.match.bool.test(t) ? _t : void 0)),
                          void 0 !== n
                              ? null === n
                ...
                if ((e = Ct(t)).length)
                    for (; (n = this[l++]); )
                        if (
                            ...
                            for (s = 0; (o = e[s++]); )
                                i.indexOf(" " + o + " ") < 0 && (i += o + " ");
                            r !== (a = Et(i)) && n.setAttribute("class", a);
                        }
                return this;
            },
            ...
            toggleClass: function (r, t) {
                ...
                return "boolean" == typeof t && s
                    ...
                    ? this.each(function (e) {
                          k(this).toggleClass(r.call(this, e, Mt(this), t), t);
                      })
                    : this.each(function () {
                          var e, t, n, i;
                          if (s)
                ...
                select: {
                    ...
                    set: function (e, t) {
                        for (
                            ...
                            ((i = r[s]).selected =
                                -1 < k.inArray(k.valHooks.option.get(i), o)) &&
                                (n = !0);
    ...
    k.extend(k.event, {
        trigger: function (e, t, n, i) {
            ...
            if (
                ...
                ((e = e[k.expando]
                    ? e
                    : new k.Event(d, "object" == typeof e && e)).isTrigger = i
                    ? 2
                    : 3),
                (e.namespace = p.join(".")),
                ...
                for (r = 0; (f = h[r++]) && !e.isPropagationStopped(); )
                    (u = f),
                        ...
                        (l =
                            ($.get(f, "events") || Object.create(null))[
                                e.type
                            ] && $.get(f, "handle")) && l.apply(f, t),
                        (l = a && f[a]) &&
                            l.apply &&
                            G(f) &&
                    ...
                    i ||
                        ...
                        (a &&
                            ...
                            e.isPropagationStopped() &&
                                u.addEventListener(d, Ot),
                            n[d](),
                            e.isPropagationStopped() &&
                                u.removeEventListener(d, Ot),
        ...
        k.extend({
            ...
            ajax: function (e, t) {
                ...
                var u,
                    ...
                    g = k.ajaxSetup({}, t),
                    y = g.context || g,
                    v = g.context && (y.nodeType || y.jquery) ? k(y) : k.event,
                    x = k.Deferred(),
                ...
                g.ifModified &&
                    ...
                    k.etag[h] &&
                        _.setRequestHeader("If-None-Match", k.etag[h])),
                ((g.data && g.hasContent && !1 !== g.contentType) ||
                    t.contentType) &&
                    _.setRequestHeader("Content-Type", g.contentType),
                _.setRequestHeader(
                    "Accept",
                ...
                g.headers))
                    _.setRequestHeader(r, g.headers[r]);
                if (g.beforeSend && (!1 === g.beforeSend.call(y, _, g) || f))
                    return _.abort();
                if (
                    ((l = "abort"),
                    b.add(g.complete),
                ...
                function c(e, t, n, i) {
                    ...
                    f ||
                        ...
                        !r &&
                            -1 < k.inArray("script", g.dataTypes) &&
                        ...
                        (_.statusText = (t || c) + ""),
                        r
                            ? x.resolveWith(y, [o, c, _])
                            : x.rejectWith(y, [_, c, s]),
                        _.statusCode(w),
                        (w = void 0),
                        m &&
                            v.trigger(r ? "ajaxSuccess" : "ajaxError", [
                                _,
                                g,
                                r ? o : s,
                            ]),
    ...
    k.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = tn.pop() || k.expando + "_" + Lt.guid++;
            return (this[e] = !0), e;
        },
    }),
        k.ajaxPrefilter("json jsonp", function (e, t, n) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                return (
                    ...
                    n.always(function () {
                        void 0 === r ? k(S).removeProp(i) : (S[i] = r),
                            e[i] &&
    ...
    return (
        (k.noConflict = function (e) {
            return (
                S.$ === k && (S.$ = sn),
                e && S.jQuery === k && (S.jQuery = on),
                k
            );
        }),
        void 0 === e && (S.jQuery = S.$ = k),
        k
    );
}),
    (function (e, t) {
        ...
        function _(e, t) {
            ...
            if ((e !== l && t !== l) || i.contains(r))
                return "BODY" === (a = (s = l).nodeName) ||
                    ...
                    : l;
            var c = u(e);
            return c.host ? _(c.host, t) : _(e, u(t).host);
        }
        function S(e, t) {
            var n =
        ...
        function E(e) {
            ...
            var r,
                ...
                l = s.height || e.clientHeight || o.bottom - o.top,
                c = e.offsetWidth - a,
                u = e.offsetHeight - l;
            return (
                (c || u) &&
        ...
        function M(e, t) {
            ...
            return (
                ...
                !r &&
                    o &&
                    ((n = parseFloat(c.marginTop, 10)),
                    (i = parseFloat(c.marginLeft, 10)),
                    (d.top -= u - n),
                    (d.bottom -= u - n),
                    (d.left -= h - i),
                    (d.right -= h - i),
                    (d.marginTop = n),
                    (d.marginLeft = i)),
                (r ? t.contains(l) : t === l && "BODY" !== l.nodeName) &&
                    (d = (function (e, t, n) {
        ...
        function p(e, t, n, i) {
            ...
            return (
                "viewport" === i
                    ? ((u = (c = y).ownerDocument.documentElement),
                      (h = M(c, u)),
                      (d = H(u.clientWidth, window.innerWidth || 0)),
                      (p = H(u.clientHeight, window.innerHeight || 0)),
                      (f = S(u)),
                      (m = S(u, "left")),
                      (g = k({
                          top: f - h.top + h.marginTop,
                          left: m - h.left + h.marginLeft,
                          width: d,
                          height: p,
                      })))
                    : ("scrollParent" === i
                          ? "BODY" === (r = x(v(t))).nodeName &&
                      ...
                      (function e(t) {
                          ...
                          return (
                              "BODY" !== n &&
                              "HTML" !== n &&
                              ("fixed" === b(t, "position") || e(v(t)))
                          );
                      })(y)
                          ? (g = o)
                          : ((a = (s = T()).height),
                            (l = s.width),
                            (g.top += o.top - o.marginTop),
                            (g.bottom = a + o.top),
                            (g.left += o.left - o.marginLeft),
                            (g.right = l + o.left))),
                (g.left += n),
                (g.top += n),
                (g.right -= n),
        ...
        for (
            ...
            if (m && 0 <= navigator.userAgent.indexOf(g[I])) {
                y = 1;
                break;
            }
        function Y(e, t, n) {
        ...
        function K(e, t) {
            ...
            W(this, K),
                ...
                Object.keys(B({}, K.Defaults.modifiers, i.modifiers)).forEach(
                    function (e) {
                        n.options.modifiers[e] = B(
                            {},
                            K.Defaults.modifiers[e] || {},
                ...
                modifiers: {
                    ...
                    arrow: {
                        ...
                        fn: function (e, t) {
                            ...
                            var r = e.placement.split("-")[0],
                                ...
                                f = C(i)[c];
                            a[p] - f < s[h] &&
                                (e.offsets.popper[h] -= s[h] - (a[p] - f)),
                                a[h] + f > s[p] &&
                                    (e.offsets.popper[h] += a[h] + f - s[p]),
                    ...
                    flip: {
                        ...
                        fn: function (f, m) {
                            ...
                            if (
                                f.flipped &&
                                f.placement === f.originalPlacement
                            )
                                return f;
                            var g = p(
                                    f.instance.popper,
                                ...
                                y = f.placement.split("-")[0],
                                v = D(y),
                                x = f.placement.split("-")[1] || "",
                                b = [];
                            switch (m.behavior) {
                                case X:
                                    b = [y, v];
                            ...
                            return (
                                b.forEach(function (e, t) {
                                    if (y !== e || b.length === t + 1) return f;
                                    (y = f.placement.split("-")[0]), (v = D(y));
                                    var n,
                                        i = f.offsets.popper,
                            ...
                            var s,
                                ...
                                m =
                                    "bottom" == d
                                        ? -c.height + h.bottom
                                        : h.top,
                                g = "right" == p ? -c.width + h.right : h.left;
                            l && f
                                ? ((u[f] =
                                      "translate3d(" +
                                      g +
                ...
                (e(l, [
                    {
                        ...
                        value: function (e, t, n, i) {
                            ...
                            var s,
                                a,
                                l = r.querySelector(this.innerSelector);
                            return (
                        ...
                        value: function (n, e, i) {
                            ...
                            e.forEach(function (e) {
                                ...
                                t.forEach(function (e) {
                                    ...
                                    r._events.push({ event: e, func: t }),
                                        n.addEventListener(e, t);
                                }),
                                o.forEach(function (e) {
                                    function t(e) {
                                        !0 === e.usedByTooltip ||
                                            r._scheduleHide(n, i.delay, i, e);
                                    }
                                    r._events.push({ event: e, func: t }),
                                        n.addEventListener(e, t);
                                });
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, i) {
                            ...
                            window.setTimeout(function () {
                                if (
                                    (window.clearTimeout(r._showTimeout),
                                    !1 !== r._isOpen &&
                                        document.body.contains(r._tooltipNode))
                                ) {
                                    if (
                                        "mouseleave" === i.type &&
                ...
                (this.show = function () {
                    ...
                    (this._setTooltipNodeEvent = function (i, r, e, o) {
                        ...
                        return (
                            ...
                            (s._tooltipNode.addEventListener(
                                i.type,
                                function e(t) {
                                    var n =
                                        t.relatedreference ||
                                        t.toElement ||
                                        t.relatedTarget;
                                    s._tooltipNode.removeEventListener(
                                        i.type,
                                        e
                                    ),
                                        r.contains(n) ||
                                            s._scheduleHide(r, o.delay, o, t);
                                }
                            ),
                            !0)
                        );
    ...
    (function (e, t) {
        ...
        var t,
            ...
            r = f.fn[n],
            a =
                (((t = l.prototype).close = function (e) {
                    var t = this._element;
                ...
                (t._removeElement = function (t) {
                    var e,
                        n = this;
                    f(t).removeClass("show"),
                        f(t).hasClass("fade")
                            ? ((e = m.getTransitionDurationFromElement(t)),
                              f(t)
                ...
                (l._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = f(this),
                            t = e.data("bs.alert");
                        t || ((t = new l(this)), e.data("bs.alert", t)),
                            "close" === n && t[n](this);
                    });
                }),
        ...
        f(document).on(
            ...
            (f.fn[n] = a._jQueryInterface),
            (f.fn[n].Constructor = a),
            (f.fn[n].noConflict = function () {
                return (f.fn[n] = r), a._jQueryInterface;
            });
        var c,
            u = f.fn.button,
            d =
                (((c = p.prototype).toggle = function () {
                    var e,
                        t,
                        n = !0,
                        i = !0,
                        r = f(this._element).closest(
                            '[data-toggle="buttons"]'
                        )[0];
                    !r ||
                        ((e = this._element.querySelector(
                        ...
                        this._element.hasAttribute("disabled") ||
                            ...
                            n && f(this._element).toggleClass("active"));
                }),
                (c.dispose = function () {
                ...
                (p._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        e || ((e = new p(this)), f(this).data("bs.button", e)),
                            "toggle" === t && e[t]();
                    });
                }),
                o(p, null, [
        ...
        f(document)
            .on(
                ...
                function (e) {
                    var t = e.target,
                        n = t;
                    if (
                        (f(t).hasClass("btn") || (t = f(t).closest(".btn")[0]),
                        !t ||
                        ...
                        ("LABEL" !== n.tagName ||
                            (i && "checkbox" !== i.type)) &&
                            d._jQueryInterface.call(f(t), "toggle");
                    }
                }
            )
            .on(
            ...
            (f.fn.button = d._jQueryInterface),
            (f.fn.button.Constructor = d),
            (f.fn.button.noConflict = function () {
                return (f.fn.button = u), d._jQueryInterface;
            });
        var g,
            y = "carousel",
            v = f.fn[y],
            ...
            _ =
                ...
                (g._getConfig = function (e) {
                    return (e = s({}, x, e)), m.typeCheckConfig(y, e, b), e;
                }),
                    ...
                    this._touchSupported &&
                        ...
                        this._pointerEvent
                            ? (f(this._element).on(
                              ...
                              f(this._element).on("pointerup.bs.carousel", t),
                              this._element.classList.add("pointer-event"))
                            : (f(this._element).on("touchstart.bs.carousel", e),
                              f(this._element).on(
                        ...
                        p =
                            "next" === e
                                ...
                                : ((n = "carousel-item-right"),
                                  ...
                                  "right");
                    u && f(u).hasClass("active")
                        ? (this._isSliding = !1)
                        : !this._triggerSlideEvent(u, p).isDefaultPrevented() &&
                          l &&
                          u &&
                          ((this._isSliding = !0),
                          d && this.pause(),
                          this._setActiveIndicatorElement(u),
                          (r = f.Event("slid.bs.carousel", {
                              relatedTarget: u,
                              direction: p,
                              from: c,
                              to: h,
                              ...
                              ? (f(u).addClass(i),
                                ...
                                (o = parseInt(
                                    ...
                                    : (this._config.interval =
                                          this._config.defaultInterval ||
                                          this._config.interval),
                                (s = m.getTransitionDurationFromElement(l)),
                                f(l)
                ...
                (S._dataApiClickHandler = function (e) {
                    ...
                    !r ||
                        ((t = f(r)[0]) &&
                            f(t).hasClass("carousel") &&
                            ((n = s({}, f(t).data(), f(this).data())),
                            (i = this.getAttribute("data-slide-to")) &&
                                (n.interval = !1),
                            S._jQueryInterface.call(f(t), n),
                            i && f(t).data("bs.carousel").to(i),
                            e.preventDefault()));
                }),
                o(S, null, [
                    {
        ...
        f(document).on(
            ...
            (f.fn[y] = _._jQueryInterface),
            (f.fn[y].Constructor = _),
            (f.fn[y].noConflict = function () {
                return (f.fn[y] = v), _._jQueryInterface;
            });
        var T,
            k = "collapse",
            E = f.fn[k],
            ...
            D =
                    ...
                    this._isTransitioning ||
                        ...
                        e &&
                            (t = f(e)
                                ...
                                .data("bs.collapse")) &&
                            t._isTransitioning) ||
                        ((n = f.Event("show.bs.collapse")),
                        f(this._element).trigger(n),
                        n.isDefaultPrevented() ||
                            (e &&
                                (O._jQueryInterface.call(
                                    f(e).not(this._selector),
                                    "hide"
                                ),
                                t || f(e).data("bs.collapse", null)),
                            ...
                            (o = m.getTransitionDurationFromElement(
                                this._element
                            )),
                            f(this._element)
                                .one(m.TRANSITION_END, function () {
                ...
                (T.dispose = function () {
                    f.removeData(this._element, "bs.collapse"),
                        (this._config = null),
                        (this._parent = null),
                        (this._element = null),
                ...
                (T._getConfig = function (e) {
                    return (
                        ((e = s({}, M, e)).toggle = Boolean(e.toggle)),
                        m.typeCheckConfig(k, e, C),
                        e
                    );
                }),
                (T._getDimension = function () {
                    return f(this._element).hasClass("width")
                        ? "width"
                        : "height";
                }),
        ...
        f(document).on(
            ...
            function (e) {
                ...
                f(i).each(function () {
                    ...
                    D._jQueryInterface.call(e, t);
                });
            }
        ),
            (f.fn[k] = D._jQueryInterface),
            (f.fn[k].Constructor = D),
            (f.fn[k].noConflict = function () {
                return (f.fn[k] = E), D._jQueryInterface;
            });
        var A,
            N = "dropdown",
            L = f.fn[N],
            ...
            H =
                (((A = I.prototype).toggle = function () {
                    var e;
                    this._element.disabled ||
                        f(this._element).hasClass("disabled") ||
                        ((e = f(this._menu).hasClass("show")),
                        I._clearMenus(),
                        e || this.show(!0));
                }),
                (A.show = function (e) {
                    if (
                        ...
                        !(
                            this._element.disabled ||
                            f(this._element).hasClass("disabled") ||
                            f(this._menu).hasClass("show")
                        ))
                    ) {
                        var t = { relatedTarget: this._element },
                            n = f.Event("show.bs.dropdown", t),
                            i = I._getParentFromElement(this._element);
                        if ((f(i).trigger(n), !n.isDefaultPrevented())) {
                            ...
                            "ontouchstart" in document.documentElement &&
                                0 === f(i).closest(".navbar-nav").length &&
                                f(document.body)
                                    .children()
                                    .on("mouseover", null, f.noop),
                                this._element.focus(),
                                this._element.setAttribute("aria-expanded", !0),
                                f(this._menu).toggleClass("show"),
                                f(i)
                                    .toggleClass("show")
                                    .trigger(f.Event("shown.bs.dropdown", t));
                        }
                    }
                }),
                (A.hide = function () {
                    ...
                    this._element.disabled ||
                        ...
                        t.isDefaultPrevented() ||
                            ...
                            f(n)
                                .toggleClass("show")
                                .trigger(f.Event("hidden.bs.dropdown", e))));
                }),
                (A.dispose = function () {
                ...
                (A._getConfig = function (e) {
                    return (
                        ...
                        m.typeCheckConfig(N, e, this.constructor.DefaultType),
                        e
                    );
                }),
                (A._getMenuElement = function () {
                    ...
                    return (
                        this._menu ||
                            ((e = I._getParentFromElement(this._element)) &&
                                (this._menu =
                ...
                (A._getPlacement = function () {
                    ...
                    return (
                        e.hasClass("dropup")
                            ? (t = f(this._menu).hasClass("dropdown-menu-right")
                                  ? "top-end"
                                  : "top-start")
                            ...
                            : e.hasClass("dropleft")
                            ? (t = "left-start")
                            : f(this._menu).hasClass("dropdown-menu-right") &&
                              (t = "bottom-end"),
                        t
                    );
                }),
                ...
                (I._clearMenus = function (e) {
                    if (
                        ...
                        for (
                            ...
                            var r,
                                o,
                                s = I._getParentFromElement(t[n]),
                                a = f(t[n]).data("bs.dropdown"),
                                l = { relatedTarget: t[n] };
                                    ...
                                    !f(s).hasClass("show") ||
                                        (e &&
                                            (("click" === e.type &&
                                                ...
                                                ("keyup" === e.type &&
                                                    9 === e.which)) &&
                                            f.contains(s, e.target)) ||
                                        ((o = f.Event("hide.bs.dropdown", l)),
                                        f(s).trigger(o),
                ...
                (I._dataApiKeydownHandler = function (e) {
                    if (
                        !(/input|textarea/i.test(e.target.tagName)
                            ? 32 === e.which ||
                              (27 !== e.which &&
                                  ((40 !== e.which && 38 !== e.which) ||
                                      f(e.target).closest(".dropdown-menu")
                                          .length))
                            : !j.test(e.which)) &&
                        !this.disabled &&
        ...
        f(document)
            ...
            .on(
                ...
                function (e) {
                    e.preventDefault(),
                        e.stopPropagation(),
                        H._jQueryInterface.call(f(this), "toggle");
                }
            )
            .on("click.bs.dropdown.data-api", ".dropdown form", function (e) {
                e.stopPropagation();
            }),
            (f.fn[N] = H._jQueryInterface),
            (f.fn[N].Constructor = H),
            (f.fn[N].noConflict = function () {
                return (f.fn[N] = L), H._jQueryInterface;
            });
        var Y,
            R = f.fn.modal,
            ...
            W =
                (((Y = V.prototype).toggle = function (e) {
                ...
                (Y.show = function (e) {
                    ...
                    this._isShown ||
                        ...
                        (t = f.Event("show.bs.modal", { relatedTarget: e })),
                        f(this._element).trigger(t),
                        this._isShown ||
                            t.isDefaultPrevented() ||
                            ((this._isShown = !0),
                ...
                (Y.handleUpdate = function () {
                    this._adjustDialog();
                }),
                (Y._getConfig = function (e) {
                    return (
                        (e = s({}, q, e)), m.typeCheckConfig("modal", e, F), e
                    );
                }),
                (Y._triggerBackdropTransition = function () {
                    var e = this;
                    if ("static" === this._config.backdrop) {
                        var t = f.Event("hidePrevented.bs.modal");
                        if ((f(this._element).trigger(t), t.defaultPrevented))
                            return;
                        var n =
                ...
                (Y._showElement = function (e) {
                    ...
                    (this._element.parentNode &&
                        ...
                        f(this._dialog).hasClass("modal-dialog-scrollable") && i
                            ? (i.scrollTop = 0)
                    ...
                    var o,
                        s = f.Event("shown.bs.modal", { relatedTarget: e });
                    n
                        ? ((o = m.getTransitionDurationFromElement(
                              this._dialog
                          )),
                ...
                (Y._enforceFocus = function () {
                    ...
                    f(document)
                        ...
                        .on("focusin.bs.modal", function (e) {
                            document !== e.target &&
                                t._element !== e.target &&
                                0 === f(t._element).has(e.target).length &&
                                t._element.focus();
                        });
                }),
                (Y._setEscapeEvent = function () {
                    var t = this;
                    this._isShown
                        ? f(this._element).on(
                        ...
                        : this._isShown ||
                          f(this._element).off("keydown.dismiss.bs.modal");
                }),
                (Y._setResizeEvent = function () {
                    var t = this;
                    this._isShown
                    ...
                    (this._element.style.display = "none"),
                        ...
                        this._showBackdrop(function () {
                            f(document.body).removeClass("modal-open"),
                                e._resetAdjustments(),
                                e._resetScrollbar(),
                                f(e._element).trigger("hidden.bs.modal");
                        });
                }),
                (Y._removeBackdrop = function () {
                    this._backdrop &&
                        (f(this._backdrop).remove(), (this._backdrop = null));
                }),
                (Y._showBackdrop = function (e) {
                    var t,
                        n,
                        i = this,
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            f(this._backdrop).addClass("show"),
                            !e)
                        )
                            return;
                        if (!r) return void e();
                ...
                (Y._resetAdjustments = function () {
                    (this._element.style.paddingLeft = ""),
                        (this._element.style.paddingRight = "");
                }),
                (Y._checkScrollbar = function () {
                    var e = document.body.getBoundingClientRect();
                    (this._isBodyOverflowing =
                        Math.round(e.left + e.right) < window.innerWidth),
                        (this._scrollbarWidth = this._getScrollbarWidth());
                }),
                (Y._setScrollbar = function () {
                    var e,
                        t,
                        n,
                        i,
        ...
        f(document).on(
            ...
            function (e) {
                ...
                var r = f(t).data("bs.modal")
                    ? "toggle"
                    : s({}, f(t).data(), f(this).data());
                ...
                W._jQueryInterface.call(f(t), r, this);
            }
        ),
            (f.fn.modal = W._jQueryInterface),
            (f.fn.modal.Constructor = W),
            (f.fn.modal.noConflict = function () {
                return (f.fn.modal = R), W._jQueryInterface;
            });
        var B = [
                "background",
                "cite",
        ...
        var $,
            ...
            J = ["sanitize", "whiteList", "sanitizeFn"],
            ee = {
                animation: "boolean",
                template: "string",
            ...
            re =
                ...
                ($.toggle = function (e) {
                    if (this._isEnabled)
                        if (e) {
                            ...
                            if (f(this.getTipElement()).hasClass("show"))
                ...
                ($.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        r.setAttribute("id", o),
                            ...
                            this.setContent(),
                            this.config.animation && f(r).addClass("fade");
                        var s =
                        ...
                        f(this.tip).hasClass("fade")
                            ? ((c = m.getTransitionDurationFromElement(
                                  this.tip
                              )),
                              f(this.tip)
                ...
                ($.hide = function (e) {
                    ...
                    f(this.element).trigger(o),
                        o.isDefaultPrevented() ||
                            ...
                            f(this.tip).hasClass("fade")
                                ? ((n = m.getTransitionDurationFromElement(r)),
                                  f(r)
                                      .one(m.TRANSITION_END, t)
                                      .emulateTransitionEnd(n))
                                : t(),
                ...
                ($.setContent = function () {
                    ...
                    this.setElementContent(
                        f(e.querySelectorAll(".tooltip-inner")),
                        this.getTitle()
                    ),
                        f(e).removeClass("fade show");
                }),
                ($.setElementContent = function (e, t) {
                ...
                ($._enter = function (e, t) {
                    ...
                    (t = t || f(e.currentTarget).data(n)) ||
                        ((t = new this.constructor(
                            e.currentTarget,
                            this._getDelegateConfig()
                        )),
                        f(e.currentTarget).data(n, t)),
                        e &&
                            (t._activeTrigger[
                                "focusin" === e.type ? "focus" : "hover"
                            ] = !0),
                        f(t.getTipElement()).hasClass("show") ||
                        "show" === t._hoverState
                            ? (t._hoverState = "show")
                ...
                ($._getConfig = function (e) {
                    ...
                    return (
                        ...
                        m.typeCheckConfig(Q, e, this.constructor.DefaultType),
                        e.sanitize &&
                            (e.template = X(
                                e.template,
                                e.whiteList,
                ...
                ($._handlePopperPlacementChange = function (e) {
        ...
        (f.fn[Q] = re._jQueryInterface),
            (f.fn[Q].Constructor = re),
            (f.fn[Q].noConflict = function () {
                return (f.fn[Q] = Z), re._jQueryInterface;
            });
        var se = "popover",
            ae = f.fn[se],
        ...
        (f.fn[se] = de._jQueryInterface),
            (f.fn[se].Constructor = de),
            (f.fn[se].noConflict = function () {
                return (f.fn[se] = ae), de._jQueryInterface;
            });
        var pe,
            fe = "scrollspy",
            me = f.fn[fe],
            ...
            ve =
                (((pe = xe.prototype).refresh = function () {
                    var t = this,
                        e =
                ...
                (pe._getConfig = function (e) {
                    ...
                    return (
                        "string" !=
                            ...
                            ((t = f(e.target).attr("id")) ||
                                ((t = m.getUID(fe)), f(e.target).attr("id", t)),
                            (e.target = "#" + t)),
                        m.typeCheckConfig(fe, e, ye),
                        e
                    );
                }),
                (pe._getScrollTop = function () {
                    return this._scrollElement === window
                        ? this._scrollElement.pageYOffset
                        : this._scrollElement.scrollTop;
                }),
                (pe._getScrollHeight = function () {
                    return (
                ...
                (pe._getOffsetHeight = function () {
                    return this._scrollElement === window
                        ? window.innerHeight
                        : this._scrollElement.getBoundingClientRect().height;
                }),
                (pe._process = function () {
                ...
                (xe._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        if (
                            (e ||
                                ((e = new xe(this, "object" == typeof t && t)),
                                f(this).data("bs.scrollspy", e)),
                            "string" == typeof t)
                        ) {
                            if (void 0 === e[t])
                                throw new TypeError(
        ...
        f(window).on("load.bs.scrollspy.data-api", function () {
            ...
            (f.fn[fe] = ve._jQueryInterface),
            (f.fn[fe].Constructor = ve),
            (f.fn[fe].noConflict = function () {
                return (f.fn[fe] = me), ve._jQueryInterface;
            });
        var be,
            we = f.fn.tab,
            _e =
                (((be = Se.prototype).show = function () {
                    var e,
                        t,
                        n,
                        i,
                    ...
                    (this._element.parentNode &&
                        this._element.parentNode.nodeType ===
                            Node.ELEMENT_NODE &&
                        f(this._element).hasClass("active")) ||
                        f(this._element).hasClass("disabled") ||
                        ...
                        t &&
                            ((i =
                                "UL" === t.nodeName || "OL" === t.nodeName
                                    ? "> li > .active"
                                    : ".active"),
                            (r = (r = f.makeArray(f(t).find(i)))[
                                r.length - 1
                            ])),
                        (o = f.Event("hide.bs.tab", {
                            relatedTarget: this._element,
                        })),
                        (s = f.Event("show.bs.tab", { relatedTarget: r })),
                        r && f(r).trigger(o),
                        f(this._element).trigger(s),
                        s.isDefaultPrevented() ||
                            ...
                            (a = function () {
                                ...
                                f(r).trigger(e), f(l._element).trigger(t);
                            }),
                ...
                (be._activate = function (e, t, n) {
                    ...
                    s && a
                        ? ((r = m.getTransitionDurationFromElement(s)),
                          f(s)
                              .removeClass("show")
                ...
                (be._transitionComplete = function (e, t, n) {
                    var i, r, o;
                    t &&
                        (f(t).removeClass("active"),
                        (i = f(t.parentNode).find(
                            "> .dropdown-menu .active"
                        )[0]) && f(i).removeClass("active"),
                        ...
                        e.parentNode &&
                            f(e.parentNode).hasClass("dropdown-menu") &&
                            ((r = f(e).closest(".dropdown")[0]) &&
                                ((o = [].slice.call(
                ...
                (Se._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = f(this),
                            t = e.data("bs.tab");
                        if (
                            (t || ((t = new Se(this)), e.data("bs.tab", t)),
                            "string" == typeof n)
                        ) {
                            if (void 0 === t[n])
                                throw new TypeError(
        ...
        f(document).on(
            ...
            function (e) {
                e.preventDefault(), _e._jQueryInterface.call(f(this), "show");
            }
        ),
            (f.fn.tab = _e._jQueryInterface),
            (f.fn.tab.Constructor = _e),
            (f.fn.tab.noConflict = function () {
                return (f.fn.tab = we), _e._jQueryInterface;
            });
        var Te,
            ke = f.fn.toast,
            ...
            Ce =
                        ...
                        i.isDefaultPrevented() ||
                            ...
                            (e = function () {
                                n._element.classList.remove("showing"),
                                    ...
                                    f(n._element).trigger("shown.bs.toast"),
                                    n._config.autohide &&
                            ...
                            this._config.animation
                                ? ((t = m.getTransitionDurationFromElement(
                                      this._element
                                  )),
                                  f(this._element)
                                      .one(m.TRANSITION_END, e)
                ...
                (Te._close = function () {
                    function e() {
                        n._element.classList.add("hide"),
                            f(n._element).trigger("hidden.bs.toast");
                    }
                    var t,
                        n = this;
                    this._element.classList.remove("show"),
                ...
                (Te._clearTimeout = function () {
                    clearTimeout(this._timeout), (this._timeout = null);
                }),
                (De._jQueryInterface = function (n) {
                    return this.each(function () {
                        var e = f(this),
                            t = e.data("bs.toast");
                        if (
                            (t ||
                                ((t = new De(this, "object" == typeof n && n)),
                                e.data("bs.toast", t)),
                            "string" == typeof n)
                        ) {
                            if (void 0 === t[n])
        ...
        (f.fn.toast = Ce._jQueryInterface),
            ...
            (f.fn.toast.noConflict = function () {
                return (f.fn.toast = ke), Ce._jQueryInterface;
            }),
            (e.Alert = a),
            (e.Button = d),
            (e.Carousel = _),
    ...
    (function (e) {
        ...
        var o,
            ...
            H =
                ...
                !1;
        P
            ? L.cancelAnimationFrame || (H = function (e) {})
            : ((o = 0),
              (P = function (e, t) {
        ...
        function a(e, t) {
                        ...
                        return (
                            "mousewheel" == i
                                ? (e.wheelDeltaX &&
                                  ...
                                  e.wheelDeltaY &&
                                      (t.deltaY = -0.025 * e.wheelDeltaY),
                                  t.deltaY ||
                                      t.deltaX ||
                                      (t.deltaY = -0.025 * e.wheelDelta))
                                : (t.deltaY = e.detail),
                            r.call(n, t)
                        );
                    },
            ...
            function a(e, t, n, i) {
                ...
                if (
                    ...
                    if (i)
                        if (e < 0) {
                            if (x.getScrollLeft() >= x.page.maxw) return 1;
                        } else if (x.getScrollLeft() <= 0) return 1;
                    var o = 0 < e ? 1 : -1;
                    v !== o &&
            ...
            function r(e, t, n) {
                ...
                return (
                    !(n || !k) ||
                    (0 === e.deltaMode
                        ? ((i = (-e.deltaX * (w.mousescrollstep / 54)) | 0),
                          (r = (-e.deltaY * (w.mousescrollstep / 54)) | 0))
                        : 1 === e.deltaMode &&
                          ((i =
                              ((-e.deltaX * w.mousescrollstep * 50) / 80) | 0),
                          (r =
                              ((-e.deltaY * w.mousescrollstep * 50) / 80) | 0)),
                    t &&
                        w.oneaxismousemode &&
                        0 === i &&
                        r &&
            ...
            var i,
                l,
                b = A("body"),
                w = (this.opt = { doc: b, win: !1 });
            if ((A.extend(w, R), (w.snapbackspeed = 80), e))
                for (var c in w) void 0 !== e[c] && (w[c] = e[c]);
            if (
                (w.disablemutationobserver && (I = !1),
                (this.doc = w.doc),
                (this.iddoc =
                    (this.doc && this.doc[0] && this.doc[0].id) || ""),
                (this.ispage = /^BODY|HTML/.test(
                    w.win ? w.win[0].nodeName : this.doc[0].nodeName
                )),
                (this.haswrapper = !1 !== w.win),
                (this.win = w.win || (this.ispage ? j : this.doc)),
                (this.docscroll =
                    this.ispage && !this.haswrapper ? j : this.win),
                (this.body = b),
                (this.viewport = !1),
                (this.isfixed = !1),
                (this.iframe = !1),
                ...
                "auto" == w.rtlmode
                    ? "horizontal-tb" ==
                          (l =
                              (i = this.win[0] == L ? this.body : this.win).css(
                                  "writing-mode"
                              ) ||
                      ...
                      "" === l
                        ...
                        : ((this.isrtlmode =
                              ...
                              "rl-tb" == l),
                          (this.isvertical =
                              "vertical-rl" == l || "tb" == l || "tb-rl" == l))
                    : ((this.isrtlmode = !0 === w.rtlmode),
                      (this.isvertical = !1)),
            ...
            (this.rail = !1),
                ...
                (this.detected = (function () {
                    ...
                    return (
                        ...
                        (s.isopera12 =
                            s.isopera && "getUserMedia" in navigator),
                        (s.isoperamini =
                            "[object OperaMini]" ===
                            Object.prototype.toString.call(L.operamini)),
                        (s.isie =
                            "all" in N && "attachEvent" in e && !s.isopera),
                        ...
                        (s.isie10 =
                            ...
                            10 === N.documentMode),
                        (s.isie11 =
                            "msRequestFullscreen" in e && 11 <= N.documentMode),
                        ...
                        (s.ischrome22 =
                            !s.ischrome38 && s.ischrome && s.haspointerlock),
                        (s.ischrome26 =
                            !s.ischrome38 && s.ischrome && "transition" in o),
                        (s.cantouch =
                        ...
                        (s.hasmstouch =
                            !s.hasw3ctouch && (L.MSPointerEvent || !1)),
                        ...
                        s.hastransform &&
                            ...
                            (s.hastranslate3d = /translate3d/.test(
                                o[s.trstyle]
                            ))),
                        ...
                        (s.cursorgrabvalue = (function () {
                            ...
                            ((s.ischrome && !s.ischrome38) || s.isie) &&
                                (e = []);
                        ...
                        (s.hasMutationObserver = !1 !== I),
                        (e = null),
                        (q = s)
                    );
                })());
            var u,
                _ = A.extend({}, this.detected);
            ...
            (this.canhwscroll = _.hastransform && w.hwacceleration),
                ...
                this.isrtlmode
                    ? this.isvertical
                        ...
                        : (this.hasreversehr = !(
                              _.iswebkit ||
                              (_.isie && !_.isie10 && !_.isie11)
                          ))
                    : (this.hasreversehr = !1),
                (this.istouchcapable = !1),
                ((_.cantouch || (!_.hasw3ctouch && !_.hasmstouch)) &&
                    (!_.cantouch ||
                        _.isios ||
                        _.isandroid ||
                        (!_.iswebkit && !_.ismozilla))) ||
                    (this.istouchcapable = !0),
                w.enablemouselockapi ||
                    ((_.hasmousecapture = !1), (_.haspointerlock = !1)),
                (this.debounced = function (e, t, n) {
                    x &&
                        (x.delaylist[e] ||
                            ((x.delaylist[e] = {
                                h: P(function () {
                                    x.delaylist[e].fn.call(x),
                                        (x.delaylist[e] = !1);
                                }, n),
                            }),
                            t.call(x)),
                ...
                (this.css = function (e, t) {
                    for (var n in t)
                        x.saved.css.push([e, n, e.css(n)]), e.css(n, t[n]);
                }),
                ...
                this.ishwscroll
                    ? ((this.doc.translate = {
                      ...
                      (u = this.isrtlmode ? 1 : -1),
                      _.hastranslate3d && w.enabletranslate3d
                      ...
                      (this.getScrollLeft = function () {
                          return x.hasreversehr
                              ? x.detected.ismozilla
                                  ? x.page.maxw -
                                    Math.abs(x.docscroll.scrollLeft())
            ...
            (this.getDocumentScrollOffset = function () {
                ...
                (this.updateScrollBar = function (e) {
                    ...
                    x.ishwscroll
                        ? (x.rail.css({
                              height:
                                  x.win.innerHeight() -
                                  (w.railpadding.top + w.railpadding.bottom),
                          }),
                          x.railh &&
                              x.railh.css({
                                  width:
                        ...
                        : (((o = {
                              top: (n = x.getOffset()).top,
                              left:
                                  n.left -
                                  (w.railpadding.left + w.railpadding.right),
                          ...
                          x.zoom &&
                              x.zoom.css({
                                  ...
                                  left:
                                      1 == x.rail.align
                                          ? o.left - 20
                                          : o.left + x.rail.width + 4,
                              }),
                          x.railh &&
                              !x.railslocked &&
                              ((o = { top: n.top, left: n.left }),
                              (t = w.railhoffset) &&
                                  (t.top && (o.top += t.top),
                                  t.left && (o.left += t.left)),
                              (i = x.railh.align
                                  ? o.top +
                                    ...
                                    x.win.innerHeight() -
                                    x.railh.height
                                  : o.top + s(x.win, "border-top-width", !0)),
                              (r = o.left + s(x.win, "border-left-width")),
                              x.railh.css({
                                  top:
                                      i -
                                      (w.railpadding.top +
                ...
                (this.doRailClick = function (e, t, n) {
                    ...
                    x.railslocked ||
                        ...
                        "pageY" in e ||
                            ((e.pageX =
                                e.clientX + N.documentElement.scrollLeft),
                            (e.pageY =
                                e.clientY + N.documentElement.scrollTop)),
                        t
                ...
                (x.hasborderbox = !1),
                (this.init = function () {
                    if (((x.saved.css = []), _.isoperamini)) return !0;
                    if (_.isandroid && !("hidden" in N)) return !0;
                    (w.emulatetouch = w.emulatetouch || w.touchbehavior),
                        (x.hasborderbox =
                            L.getComputedStyle &&
                            "border-box" ===
                                L.getComputedStyle(N.body)["box-sizing"]);
                    var e,
                        n = { "overflow-y": "hidden" };
                    if (
                        ((_.isie11 || _.isie10) &&
                        ...
                        x.ishwscroll &&
                            (this.doc.css(
                                _.transitionstyle,
                                _.prefixstyle + "transform 0ms ease-out"
                            ),
                            _.transitionend &&
                                x.bind(
                                    x.doc,
                        ...
                        var t = x.docscroll;
                        x.ispage && (t = x.haswrapper ? x.win : x.doc),
                            x.css(t, n),
                            x.ispage &&
                                (_.isie11 || _.isie) &&
                                x.css(A("html"), n),
                        ...
                        for (var l in a)
                            (s = a[l]),
                                (o = w.railpadding[s] || 0) &&
                                    r.css("padding-" + s, o + "px");
                        r.append(i),
                            (r.width = Math.max(
                                parseFloat(w.cursorwidth),
                                i.outerWidth()
                            )),
                            r.css({
                                width: r.width + "px",
                        ...
                        !w.boxzoom ||
                            ...
                            x.bind(v, "click", x.doZoom),
                            x.bind(v, "mouseenter", function () {
                                x.zoom.css("opacity", w.cursoropacitymax);
                            }),
                            x.bind(v, "mouseleave", function () {
                                x.zoom.css("opacity", w.cursoropacitymin);
                            }),
                            (x.zoom = A(v)),
                            x.zoom.css({
                                cursor: "pointer",
                                zIndex: x.zindex,
                                backgroundImage:
                                    "url(" + w.scriptpath + "zoomico.png)",
                                height: 18,
                                width: 18,
                                backgroundPosition: "0 0",
                            }),
                            w.dblclickzoom &&
                                x.bind(x.win, "dblclick", x.doZoom),
                            _.cantouch &&
                                w.gesturezoom &&
                            ...
                            (x.railh = !1),
                            w.horizrailenabled &&
                                (x.css(t, { overflowX: "hidden" }),
                                (i = A(N.createElement("div"))).css({
                                    position: "absolute",
                                    top: 0,
                                    ...
                                    "-webkit-border-radius":
                                        w.cursorborderradius,
                                    "-moz-border-radius": w.cursorborderradius,
                                    "border-radius": w.cursorborderradius,
                                }),
                                _.isieold && i.css("overflow", "hidden"),
                                i.addClass("nicescroll-cursors"),
                                (x.cursorh = i),
                                (c = A(N.createElement("div"))).attr(
                                    "id",
                                    x.id + "-hr"
                                ),
                                c.addClass(
                                ...
                                : (x.ishwscroll
                                      ? ("static" == x.win.css("position") &&
                                        ...
                                        c &&
                                            ...
                                            u.append(c)))
                                      : ((x.isfixed =
                                            "fixed" == x.win.css("position")),
                                        (h = x.isfixed ? "fixed" : "absolute"),
                                        x.isfixed ||
                                            (x.viewport = x.getViewport(
                                                x.win[0]
                                            )),
                                        x.viewport &&
                                            ((x.body = x.viewport),
                                            /fixed|absolute/.test(
                                                x.viewport.css("position")
                                            ) ||
                                                x.css(x.viewport, {
                                                    position: "relative",
                                                })),
                                  ...
                                  w.disableoutline &&
                                      (_.isie &&
                                          x.win.attr("hideFocus", "true"),
                                      _.iswebkit &&
                                          x.win.css("outline", "none"))),
                            !1 === w.autohidemode
                                ? ((x.autohidedom = !1),
                                  x.rail.css({ opacity: w.cursoropacitymax }),
                                  x.railh &&
                                      x.railh.css({
                                          opacity: w.cursoropacitymax,
                                      }))
                                : !0 === w.autohidemode ||
                                  "leave" === w.autohidemode
                            ...
                            (_.cantouch ||
                                ...
                                (x.ontouchstart = function (e) {
                                    ...
                                    if (
                                        ...
                                        if (
                                            ...
                                            x.ispage || !w.directionlockdeadzone
                                                ? (x.rail.drag.dl = "f")
                                                : ((i = j.width()),
                                                  (r = j.height()),
                                                  (s =
                                ...
                                (x.ontouchend = function (e) {
                                    ...
                                    } else if (1 == x.rail.drag.pt)
                                        return x.onmouseup(e);
                                }),
                                (f =
                                    w.emulatetouch &&
                                    x.isiframe &&
                                    !_.hasmousecapture),
                                (m = (0.3 * w.directionlockdeadzone) | 0),
                                (x.ontouchmove = function (e, t) {
                                    if (!x.rail.drag) return !0;
                                    if (
                                        e.targetTouches &&
                                        w.preventmultitouchscrolling &&
                                    ...
                                    var o = e.clientY + r,
                                        ...
                                        l = a - x.rail.drag.x,
                                        c = x.rail.drag.st - s;
                                    if (x.ishwscroll && w.bouncescroll)
                                        c < 0
                                            ? (c = Math.round(c / 2))
                                            : c > x.page.maxh &&
                                              (c =
                            ...
                            (x.onmousedown = function (e, t) {
                                if (!x.rail.drag || 1 == x.rail.drag.pt) {
                                    ...
                                    var n = x.getTarget(e);
                                    return (
                                        _.hasmousecapture && n.setCapture(),
                                        x.isiframe &&
                                            !_.hasmousecapture &&
                                            ((x.saved.csspointerevents =
                            ...
                            _.cantouch || w.emulatetouch
                                ...
                                : ((d = function (e) {
                                      ...
                                      x.selectiondrag &&
                                          ...
                                          0 !== x.selectiondrag.df &&
                                              ((i =
                                                  ((-2 * x.selectiondrag.df) /
                                                      6) |
                                                  0),
                                              x.doScrollBy(i),
                                              x.debounced(
                                  ...
                                  (x.hasTextSelected =
                                      "getSelection" in N
                                          ? function () {
                                                return (
                                                    0 <
                                                    N.getSelection().rangeCount
                                                );
                                            }
                                          : "selection" in N
                                          ? function () {
                                                return (
                                                    "None" != N.selection.type
                                                );
                                            }
                                          : function () {
                                                return !1;
                            ...
                            (!w.cursordragontouch &&
                                ...
                                x.jqbind(x.rail, "mouseenter", function () {
                                    return (
                                        !(!x.ispage && !x.win.is(":visible")) &&
                                        (x.canshowonmouseevent &&
                                            x.showCursor(),
                                        void (x.rail.active = !0))
                                    );
                                }),
                            ...
                            w.emulatetouch || _.isandroid || _.isios
                                ? (x.bind(
                                      _.hasmousecapture ? x.win : N,
                                      "mouseup",
                                      x.ontouchend
                                  ),
                            ...
                            w.enablemousewheel &&
                                (x.isiframe ||
                                    x.mousewheel(
                                        _.isie && x.ispage ? N : x.win,
                                        x.onmousewheel
                                    ),
                                x.mousewheel(x.rail, x.onmousewheel),
                                x.railh &&
                                    x.mousewheel(x.railh, x.onmousewheelhr)),
                            x.ispage ||
                                _.cantouch ||
                                /HTML|^BODY/.test(x.win[0].nodeName) ||
                                (x.win.attr("tabindex") ||
                                    x.win.attr({ tabindex: ++C }),
                            ...
                            (x.onkeypress = function (e) {
                                if (x.railslocked && 0 === x.page.maxh)
                                    return !0;
                                e = e || L.event;
                                var t = x.getTarget(e);
                                if (
                            ...
                            !w.enableobserver ||
                                (x.isie11 ||
                                    !1 === I ||
                                    ((x.observerbody = new I(function (e) {
                                        if (
                                            (e.forEach(function (e) {
                                ...
                                !1 !== I
                                    ? ((x.observer = new I(function (e) {
                                      ...
                                      (x.observerremover = new I(function (e) {
                                          e.forEach(function (e) {
                    ...
                    "IFRAME" == this.doc[0].nodeName &&
                        ((e = function () {
                            ...
                            (x.forcescreen = !0),
                                ...
                                w.enablemousewheel &&
                                    x.mousewheel(t, x.onmousewheel),
                                w.enablekeyboard &&
                                    x.bind(
                                        t,
                                        _.isopera ? "keypress" : "keydown",
                                        x.onkeypress
                                    ),
                                _.cantouch
                    ...
                    x.cursortimeout &&
                        ...
                        x.rail &&
                            (x.autohidedom &&
                                (x.autohidedom
                                    .stop()
                                    .css({ opacity: w.cursoropacitymax }),
                                (x.cursoractive = !0)),
                            (x.rail.drag && 1 == x.rail.drag.pt) ||
                                ...
                                void 0 !== t &&
                                    (x.scroll.x = (t / x.scrollratio.x) | 0)),
                            x.cursor.css({
                            ...
                            x.cursorh &&
                                ...
                                x.cursorh.css({
                                    width: x.cursorwidth,
                                    left:
                                        !x.rail.align && x.rail.visibility
                                            ? n + x.rail.width
                                            : n,
                                }),
                                (x.cursoractive = !0)),
                    ...
                    return (
                        ...
                        0 === x.page.maxw
                            ...
                            : ((x.page.maxw -=
                                  w.railpadding.left + w.railpadding.right),
                              x.railh &&
                                  (x.railh.scrollable = w.horizrailenabled)),
                        (x.railslocked =
                            x.locked ||
                            (0 === x.page.maxh && 0 === x.page.maxw)),
                        x.railslocked
                            ...
                            : (x.hidden ||
                              ...
                              (x.cursorheight = w.cursorfixedheight
                                  ? w.cursorfixedheight
                                  : Math.max(
                                        w.cursorminheight,
                                        x.cursorheight
                              ...
                              (x.cursorwidth = w.cursorfixedheight
                                  ? w.cursorfixedheight
                                  : Math.max(w.cursorminheight, x.cursorwidth)),
                              (x.scrollvaluemax =
                                  x.view.h -
                                  x.cursorheight -
                                  (w.railpadding.top + w.railpadding.bottom)),
                              x.hasborderbox ||
                                  (x.scrollvaluemax -=
                                      x.cursor[0].offsetHeight -
                                      x.cursor[0].clientHeight),
                              x.railh &&
                                  ((x.railh.width =
                                      0 < x.page.maxh
                                          ? x.view.w - x.rail.width
                                          : x.view.w),
                                  (x.scrollvaluemaxw =
                                      x.railh.width -
                                      x.cursorwidth -
                              ...
                              x.getScrollTop() > x.page.maxh
                                  ...
                                  : ((x.scroll.y =
                                        (x.getScrollTop() / x.scrollratio.y) |
                                        0),
                                    (x.scroll.x =
            ...
            var f = !(this.mousewheel = function (e, t, n) {
                var i,
                    r = "jquery" in e ? e[0] : e;
                "onwheel" in N.createElement("div")
                    ? x._bind(r, "wheel", t, n || !1)
                    : (o(
                          r,
                          (i =
            ...
            (this.delegate = function (e, t, n, i, r) {
                ...
                (this._bind = function (e, t, n, i, r) {
                    x.events.push({ e: e, n: t, f: n, b: i, q: !1 }),
                        f && r
                ...
                (this.showRailHr = function () {
                    return (
                        x.railh &&
                            (0 === x.page.maxw ||
                                (!x.ispage && "none" == x.win.css("display")) ||
                                ((x.railh.visibility = !0),
                                x.railh.css("display", "block"))),
                        x
                    );
                }),
                ...
                (this.hideRailHr = function () {
                    return (
                        x.railh &&
                            ((x.railh.visibility = !1),
                            x.railh.css("display", "none")),
                        x
                    );
                }),
                (this.show = function () {
                ...
                (this.remove = function () {
                    ...
                    x.delaylist))
                        x.delaylist[e] && H(x.delaylist[e].h);
                    x.doZoomOut(),
                        x.unbindAll(),
                        _.isie9 &&
                            x.win[0].detachEvent(
                ...
                (this.triggerScrollStart = function (e, t, n, i, r) {
                    ...
                    x.onscrollstart &&
                        ((o = {
                            ...
                            current: { x: e, y: t },
                            request: { x: n, y: i },
                            end: { x: x.newscrollx, y: x.newscrolly },
                            speed: r,
                        }),
            ...
            (this.onmousewheel = function (e) {
                ...
                if (
                    ("auto" === w.oneaxismousemode &&
                        0 !== e.deltaX &&
                        (w.oneaxismousemode = !1),
                    w.oneaxismousemode && 0 === e.deltaX && !x.rail.scrollable)
                )
                    return (
                        !x.railh || !x.railh.scrollable || x.onmousewheelhr(e)
                    );
                var t = Y(),
                    n = !1;
                if (
                    (w.preservenativescrolling &&
                        x.checkarea + 600 < t &&
                ...
                (this.onmousewheelhr = function (e) {
                    if (!x.wheelprevented) {
                        ...
                        return (
                            w.preservenativescrolling &&
                                x.checkarea + 600 < t &&
                                ((x.nativescrollingarea = x.isScrollable(e)),
                                (n = !0)),
                            (x.checkarea = t),
                            !!x.nativescrollingarea ||
                ...
                (this.stop = function () {
                    return (
                        ...
                        (x.cursorfreezed = !1),
                        (x.scroll.y = Math.round(
                            x.getScrollTop() * (1 / x.scrollratio.y)
                        )),
                        x.noticeCursor(),
                        x
                    );
                      ...
                      w.smoothscroll
                        ? ((g = ""),
                          (this.resetTransition = function () {
                              (g = ""),
                                  x.doc.css(
                                      _.prefixstyle + "transition-duration",
                                      "0ms"
                                  );
                          }),
                          ...
                          (this.doScrollPos = function (e, t, n) {
                              ...
                              x.scrollrunning ||
                                  ...
                                  _.transitionend ||
                                      (x.scrollendtrapped &&
                                          clearTimeout(x.scrollendtrapped),
                        ...
                        : ((this.doScrollLeft = function (e, t) {
                          ...
                          (this.doScrollPos = function (e, t, n) {
                              ...
                              var s =
                                      0 |
                                      Math.sqrt(
                                          x.dst.x * x.dst.x + x.dst.y * x.dst.y
                                      ),
                ...
                (this.doZoomIn = function (e) {
                    if (!x.zoomactive) {
                        ...
                        (x.zoomrestore.style.width = x.win.css("width")),
                            ...
                            _.isios4 &&
                                ((x.zoomrestore.scrollTop = j.scrollTop()),
                                j.scrollTop(0)),
                            x.win.css({
                ...
                (this.doZoomOut = function (e) {
                    if (x.zoomactive)
                        return (
                            ...
                            _.isios4 && j.scrollTop(x.zoomrestore.scrollTop),
                ...
                (this.resizeZoom = function () {
                    ...
                    x.zoomactive &&
                        ((e = x.getScrollTop()),
                        x.win.css({
                            width: j.width() - x.zoomrestore.padding.w + "px",
                            height: j.height() - x.zoomrestore.padding.h + "px",
                        }),
                        x.onResize(),
        ...
        var t,
            n,
            i,
            I = L.MutationObserver || L.WebKitMutationObserver || !1,
            Y =
                Date.now ||
                function () {
                ...
                scriptpath:
                    ((n =
                        ...
                        (!!(t = N.getElementsByTagName("script")).length &&
                            t[t.length - 1])),
                    0 < (i = n ? n.src.split("?")[0] : "").split("/").length
                ...
                (this.nc = e),
                    ...
                    (this.doSnapy = function (e, t) {
                        ...
                        t < 0
                            ? (n = !(t = 0))
                            : t > m.nc.page.maxh &&
                              ((t = m.nc.page.maxh), (n = !0)),
                            e < 0
                                ? (n = !(e = 0))
                                : e > m.nc.page.maxw &&
                                  ((e = m.nc.page.maxw), (n = !0)),
                            n
                    ...
                    (this.doMomentum = function (e) {
                        ...
                        var l,
                            ...
                            h,
                            d,
                            p = !(!m.speedy || !a) && m.speedy,
                            f = !(!m.speedx || !a) && m.speedx;
                        p || f
                            ? (50 < (l = Math.max(16, m.steptime)) &&
                                  ((c = l / 50),
                                  (m.speedx *= c),
                                  (m.speedy *= c),
                                  (l = 50)),
                              ...
                              (d = function () {
                                  ...
                                  m.speedx &&
                                      ((u = Math.floor(
                                          m.lastscrollx -
                                              m.speedx * (1 - m.demulxy)
                                      )),
                                      ((m.lastscrollx = u) < 0 || s < u) &&
                                          (e = 0.1)),
                                      m.speedy &&
                                          ((h = Math.floor(
                                              m.lastscrolly -
                                                  m.speedy * (1 - m.demulxy)
                                          )),
                                          ((m.lastscrolly = h) < 0 || o < h) &&
                                              (e = 0.1)),
        ...
        !(function (e, t) {
            ...
            (A.fn.niceScroll = function (r, o) {
                ...
                return (
                    this.each(function () {
                        ...
                        r &&
                            ((e = A(r)),
                            (n.doc = 1 < e.length ? A(r, t) : e),
                            (n.win = t)),
                            !("doc" in n) || "win" in n || (n.win = t);
                        var i = t.data("__nicescroll") || !1;
                        i ||
                            ((n.doc = n.doc || t),
                            (i = new a(n, t)),
                            t.data("__nicescroll", i)),
                            s.push(i);
                    }),
                    1 === s.length ? s[0] : s
                );
            ...
            A.nicescroll ||
                ((A.nicescroll = new l()), (A.nicescroll.options = R));
    }),
    (function (e, t) {
        "object" == typeof exports && "undefined" != typeof module
            ? (module.exports = t())
        ...
        function w(e) {
            var t = y(NaN);
            return null != e ? m(b(t), e) : (b(t).userInvalidated = !0), t;
        }
        function _(e, t) {
            var n, i, r;
            if (
        ...
        function S(e) {
            _(this, e),
                ...
                !1 === Ke && ((Ke = !0), x.updateOffset(this), (Ke = !1));
        }
        function T(e) {
        ...
        function o(e, t) {
            null != x.deprecationHandler && x.deprecationHandler(e, t),
                Je[e] || (a(t), (Je[e] = !0));
        }
        function l(e) {
            return (
        ...
        function M(e, t) {
            ...
            for (n in t)
                g(t, n) &&
                    (u(e[n]) && u(t[n])
                        ? ((i[n] = {}), m(i[n], e[n]), m(i[n], t[n]))
                        : null != t[n]
                        ? (i[n] = t[n])
                        : delete i[n]);
            for (n in e) g(e, n) && !g(t, n) && u(e[n]) && (i[n] = m({}, i[n]));
            return i;
        }
        function C(e) {
            null != e && this.set(e);
        ...
        function O(e) {
            var t,
                n,
                i = {};
            for (n in e) g(e, n) && (t = D(n)) && (i[t] = e[n]);
            return i;
        }
        function n(e, t) {
            tt[e] = t;
            ...
            return e.isValid()
                ? ((t = N(t, e.localeData())),
                  (rt[t] =
                      ...
                      (function (i) {
                          for (
                              var e, r = i.match(nt), t = 0, o = r.length;
                              t < o;
                              t++
                          )
                              ot[r[t]]
        ...
        function N(e, t) {
            ...
            for (it.lastIndex = 0; 0 <= i && it.test(e); )
                (e = e.replace(it, n)), (it.lastIndex = 0), --i;
            return e;
        }
        function L(e, n, i) {
            _t[e] = l(n)
        ...
        function R(t, n) {
            return function (e) {
                return null != e
                    ? (F(this, t, e), x.updateOffset(this, n), this)
                    : q(this, t);
            };
        }
        function q(e, t) {
        ...
        function B(e) {
            return null != e
                ? (V(this, e), x.updateOffset(this, !0), this)
                : q(this, "Month");
        }
        function U() {
            function e(e, t) {
            ...
            for (n.sort(e), i.sort(e), r.sort(e), o = 0; o < 12; o++)
                (n[o] = z(n[o])), (i[o] = z(i[o]));
            for (o = 0; o < 24; o++) r[o] = z(r[o]);
        ...
        function Q(e, t, n) {
            ...
            return (
                s < 1
                    ? (i = s + Z((r = e.year() - 1), t, n))
                    : s > Z(e.year(), t, n)
                    ? ((i = s - Z(e.year(), t, n)), (r = e.year() + 1))
                    : ((r = e.year()), (i = s)),
                { week: i, year: r }
            );
        }
        ...
        function K() {
            ...
            for (
                ...
                (t = y([2e3, 1]).day(c)),
                    ...
                    l.push(i),
                    l.push(r);
            for (o.sort(e), s.sort(e), a.sort(e), l.sort(e), c = 0; c < 7; c++)
                (s[c] = z(s[c])), (a[c] = z(a[c])), (l[c] = z(l[c]));
        ...
        function ie(e) {
            ...
            if (
                ...
                try {
                    (t = Ut._abbr), require("./locale/" + e), re(t);
                } catch (e) {}
            return $t[e];
        }
        function re(e, t) {
            var n;
            return e && (n = h(t) ? se(e) : oe(e, t)) && (Ut = n), Ut._abbr;
        }
        function oe(e, t) {
            ...
            if (((t.abbr = e), null != $t[e]))
                ...
                if (null == $t[t.parentLocale])
                    return (
                        Qt[t.parentLocale] || (Qt[t.parentLocale] = []),
                        Qt[t.parentLocale].push({ name: e, config: t }),
                        null
                    );
            ...
            return (
                n &&
                    ...
                    ((t =
                        n[kt] < 0 || 11 < n[kt]
                            ? kt
                            : n[Et] < 1 || n[Et] > W(n[Tt], n[kt])
                            ? Et
                            : n[Mt] < 0 ||
                              24 < n[Mt] ||
                              (24 === n[Mt] &&
                                  (0 !== n[Ct] || 0 !== n[Dt] || 0 !== n[Ot]))
                            ? Mt
                            : n[Ct] < 0 || 59 < n[Ct]
                            ? Ct
                            : n[Dt] < 0 || 59 < n[Dt]
                            ...
                            ? Ot
                            : -1),
                    b(e)._overflowDayOfYear && (t < Tt || Et < t) && (t = Et),
                    b(e)._overflowWeeks && -1 === t && (t = At),
                    b(e)._overflowWeekday && -1 === t && (t = Nt),
                    (b(e).overflow = t)),
                e
            );
        }
                ...
                for (
                    g = e,
                        ...
                        i = g._useUTC
                            ...
                            : [y.getFullYear(), y.getMonth(), y.getDate()],
                        e._w &&
                            null == e._a[Et] &&
                            null == e._a[kt] &&
                            (null != (a = (s = e)._w).GG ||
                            ...
                            null != a.E
                                ? ((c = 1),
                                  (u = 4),
                                  (f = le(a.GG, s._a[Tt], Q(me(), 1, 4).year)),
                                  (m = le(a.W, 1)),
                                  ((l = le(a.E, 1)) < 1 || 7 < l) && (d = !0))
                                : ((c = s._locale._week.dow),
                                  (u = s._locale._week.doy),
                                  (p = Q(me(), c, u)),
                                  (f = le(a.gg, s._a[Tt], p.year)),
                                  (m = le(a.w, p.week)),
                                  null != a.d
                                      ? ((l = a.d) < 0 || 6 < l) && (d = !0)
                                      : null != a.e
                                      ...
                                      : (l = c)),
                            m < 1 || m > Z(f, c, u)
                                ? (b(s)._overflowWeeks = !0)
                                : null != d
                                ? (b(s)._overflowWeekday = !0)
                                : ((h = $(f, m, l, c, u)),
                                  (s._a[Tt] = h.year),
                                  (s._dayOfYear = h.dayOfYear))),
                        null != e._dayOfYear &&
                            ((o = le(e._a[Tt], i[Tt])),
                            (e._dayOfYear > I(o) || 0 === e._dayOfYear) &&
                                (b(e)._overflowDayOfYear = !0),
                            (n = G(o, 0, e._dayOfYear)),
                            (e._a[kt] = n.getUTCMonth()),
                            (e._a[Et] = n.getUTCDate())),
                        t = 0;
                    t < 3 && null == e._a[t];
                    ++t
                )
        ...
        function ue(e) {
            var t,
                ...
                s,
                a = e._i,
                l = Zt.exec(a) || Kt.exec(a);
            if (l) {
                for (b(e).iso = !0, t = 0, n = en.length; t < n; t++)
                    if (en[t][1].exec(l[1])) {
                        (r = en[t][0]), (i = !1 !== en[t][2]);
                        break;
                    }
                ...
                if (!i && null != o) return (e._isValid = !1);
                if (l[4]) {
                    if (!Jt.exec(l[4])) return (e._isValid = !1);
                    s = "Z";
                }
                (e._f = r + (o || "") + (s || "")), de(e);
            } else e._isValid = !1;
        ...
        function he(e) {
            ...
            if (d) {
                ...
                if (
                    ...
                    (i = e),
                    t &&
                        qt.indexOf(t) !== new Date(n[0], n[1], n[2]).getDay() &&
            ...
            if (e._f !== x.ISO_8601)
                if (e._f !== x.RFC_2822) {
                    ...
                    for (
                        ...
                        (n = a[l]),
                            (t = (r.match(j(n, e)) || [])[0]) &&
                                (0 < (i = r.substr(0, r.indexOf(t))).length &&
                                    b(e).unusedInput.push(i),
                                (r = r.slice(r.indexOf(t) + t.length)),
                                (s += t.length)),
                            ot[n]
                                ? (t
                                      ? (b(e).empty = !1)
                                      : b(e).unusedTokens.push(n),
                                  (p = n),
                                  (m = e),
                                  null != (f = t) &&
                                      g(St, p) &&
                                      St[p](f, m._a, m, p))
                                : e._strict && !t && b(e).unusedTokens.push(n);
                    (b(e).charsLeftOver = o - s),
                        0 < r.length && b(e).unusedInput.push(r),
                        e._a[Mt] <= 12 &&
                            !0 === b(e).bigHour &&
                            0 < e._a[Mt] &&
                            (b(e).bigHour = void 0),
                                  ...
                                  null === (o = nn.exec(r._i))
                                      ? (ue(r),
                                        !1 === r._isValid &&
                                            ...
                                            !1 === r._isValid &&
                                                (delete r._isValid,
                                                x.createFromInputFallback(r))))
                                      : (r._d = new Date(+o[1])))
                                : c(s)
                                ? ((t._a = f(s.slice(0), function (e) {
        ...
        function ge(e, t) {
            var n, i;
            if ((1 === t.length && c(t[0]) && (t = t[0]), !t.length))
                return me();
        ...
        function ye(e) {
            ...
            (this._isValid = (function (e) {
                for (var t in e)
                    if (-1 === jt.call(ln, t) || (null != e[t] && isNaN(e[t])))
                        return !1;
                for (var n = !1, i = 0; i < ln.length; ++i)
                    if (e[ln[i]]) {
                        if (n) return !1;
                        parseFloat(e[ln[i]]) !== E(e[ln[i]]) && (n = !0);
                    }
                return !0;
            })(t)),
                (this._milliseconds =
        ...
        function _e(e, t) {
            ...
            return t._isUTC
                ? ((n = t.clone()),
                  (i =
                      (T(e) || p(e) ? e.valueOf() : me(e).valueOf()) -
                      n.valueOf()),
            ...
            return (
                ve(e)
                    ...
                    : "object" == typeof l &&
                      ...
                      (l.M = r.months)),
                (i = new ye(l)),
                ve(e) && g(e, "_locale") && (i._locale = e._locale),
                i
            );
        }
        function Ee(e, t) {
            ...
            return function (e, t) {
                ...
                return (
                    null === t ||
                        ...
                        (e = t),
                        (t = n)),
                    De(this, ke((e = "string" == typeof e ? +e : e), t), i),
                    this
                );
            };
        }
        function De(e, t, n, i) {
            ...
            e.isValid() &&
                ((i = null == i || i),
                s && V(e, q(e, "Month") + s * n),
                o && F(e, "Date", q(e, "Date") + o * n),
                r && e._d.setTime(e._d.valueOf() + r * n),
                i && x.updateOffset(e, o || s));
        }
        function Oe(e, t) {
        ...
        function Ie(e, t, n) {
            if ((d(e) && ((t = e), (e = void 0)), (e = e || ""), null != t))
                return He(e, t, n, "month");
            for (var i = [], r = 0; r < 12; r++) i[r] = He(e, r, n, "month");
            return i;
        }
        function Ye(e, t, n, i) {
            t =
            ...
            var r = se(),
                o = e ? r._week.dow : 0;
            if (null != n) return He(t, (n + o) % 7, i, "day");
            for (var s = [], a = 0; a < 7; a++)
                s[a] = He(t, (a + o) % 7, i, "day");
            return s;
        }
        function Re(e, t, n, i) {
            var r = ke(t, n);
        ...
        function Ge() {
            ...
            var o = k(i / 12),
                ...
                l = r,
                c = e,
                u = t ? t.toFixed(3).replace(/\.?0+$/, "") : "",
                h = this.asSeconds();
            if (!h) return "P0D";
            var d = h < 0 ? "-" : "",
                p = Ue(this._months) !== Ue(h) ? "-" : "",
                f = Ue(this._days) !== Ue(h) ? "-" : "",
                m = Ue(this._milliseconds) !== Ue(h) ? "-" : "";
            return (
                d +
                "P" +
                (o ? p + o + "Y" : "") +
        ...
        i("Y", 0, 0, function () {
            ...
            P(["YYYYY", "YYYYYY"], Tt),
            P("YYYY", function (e, t) {
                t[Tt] = 2 === e.length ? x.parseTwoDigitYear(e) : E(e);
            }),
            P("YY", function (e, t) {
                t[Tt] = x.parseTwoDigitYear(e);
            }),
            P("Y", function (e, t) {
                t[Tt] = parseInt(e, 10);
            }),
        ...
        i("M", ["MM", 2], "Mo", function () {
            ...
            P(["MMM", "MMMM"], function (e, t, n, i) {
                ...
                null != r ? (t[kt] = r) : (b(n).invalidMonth = e);
            });
        var zt = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
            Pt =
        ...
        i("w", ["ww", 2], "wo", "week"),
            ...
            H(["dd", "ddd", "dddd"], function (e, t, n, i) {
        ...
        i("H", ["HH", 2], 0, "hour"),
            ...
            P("Hmm", function (e, t, n) {
                var i = e.length - 2;
                (t[Mt] = E(e.substr(0, i))), (t[Ct] = E(e.substr(i)));
            }),
            P("Hmmss", function (e, t, n) {
                var i = e.length - 4,
                    r = e.length - 2;
        ...
        i(0, ["gg", 2], 0, function () {
            ...
            L("GGGGG", gt, ut),
            L("ggggg", gt, ut),
            H(["gggg", "ggggg", "GGGG", "GGGGG"], function (e, t, n, i) {
                t[i.substr(0, 2)] = E(e);
            }),
            H(["gg", "GG"], function (e, t, n, i) {
        ...
        for (
            ...
            L(yn, yt);
        for (yn = "S"; yn.length <= 9; yn += "S") P(yn, ze);
        ...
        (bn.add = dn),
            (bn.calendar = function (e, t) {
                var n = e || me(),
                    ...
                    r = x.calendarFormat(this, i) || "sameElse",
                    o = t && (l(t[r]) ? t[r].call(this, n) : t[r]);
                return this.format(
                    o || this.localeData().calendar(r, this, me(n))
                );
            }),
            (bn.clone = function () {
                return new S(this);
            ...
            (bn.diff = function (e, t, n) {
                ...
                switch (
                    ((r = 6e4 * (i.utcOffset() - this.utcOffset())), (t = D(t)))
                ) {
                    case "year":
                        o = Oe(this, i) / 12;
                        break;
            ...
            (bn.isAfter = function (e, t) {
                ...
                return (
                    ...
                    ("millisecond" === (t = D(h(t) ? "millisecond" : t))
            ...
            (bn.hour = bn.hours = Gt),
            (bn.minute = bn.minutes = gn),
            (bn.second = bn.seconds = vn),
            (bn.millisecond = bn.milliseconds = xn),
        ...
        (wn.calendar = function (e, t, n) {
            ...
            (wn.preparse = Pe),
            (wn.postformat = Pe),
            (wn.relativeTime = function (e, t, n, i) {
            ...
            (wn.months = function (e, t) {
                return e
                    ? c(this._months)
                        ...
                        : this._months[
                              (this._months.isFormat || zt).test(t)
                                  ? "format"
                                  : "standalone"
                          ][e.month()]
                    : c(this._months)
                ...
                if (this._monthsParseExact)
                    return function (e, t, n) {
                        ...
                        return n
                            ? "MMM" === t
                                ? -1 !==
                                  (r = jt.call(this._shortMonthsParse, s))
                                    ? r
                                    : null
                                : -1 !== (r = jt.call(this._longMonthsParse, s))
                                ? r
                                : null
                            : "MMM" === t
                            ? -1 !== (r = jt.call(this._shortMonthsParse, s)) ||
                              -1 !== (r = jt.call(this._longMonthsParse, s))
                                ? r
                                : null
                            : -1 !== (r = jt.call(this._longMonthsParse, s)) ||
            ...
            (wn.monthsRegex = function (e) {
                return this._monthsParseExact
                    ? (g(this, "_monthsRegex") || U.call(this),
                      e ? this._monthsStrictRegex : this._monthsRegex)
                    : (g(this, "_monthsRegex") || (this._monthsRegex = Yt),
            ...
            (wn.weekdaysParse = function (e, t, n) {
                ...
                if (this._weekdaysParseExact)
                    return function (e, t, n) {
                        ...
                        return n
                            ? "dddd" === t
                                ? -1 !== (r = jt.call(this._weekdaysParse, s))
                                    ? r
                                    : null
                                : "ddd" === t
                                ? -1 !==
                                  (r = jt.call(this._shortWeekdaysParse, s))
                                    ? r
                                    : null
                                : -1 !==
                                  (r = jt.call(this._minWeekdaysParse, s))
                                ? r
                                : null
                            : "dddd" === t
                            ? -1 !== (r = jt.call(this._weekdaysParse, s)) ||
                              -1 !==
                                  (r = jt.call(this._shortWeekdaysParse, s)) ||
                              -1 !== (r = jt.call(this._minWeekdaysParse, s))
                                ? r
                                : null
                            : "ddd" === t
                            ? -1 !==
                            ...
                            : -1 !== (r = jt.call(this._minWeekdaysParse, s)) ||
                              -1 !== (r = jt.call(this._weekdaysParse, s)) ||
                              -1 !== (r = jt.call(this._shortWeekdaysParse, s))
                            ? r
                            : null;
                    }.call(this, e, t, n);
                for (
            ...
            (wn.weekdaysRegex = function (e) {
                return this._weekdaysParseExact
                    ? (g(this, "_weekdaysRegex") || K.call(this),
                      e ? this._weekdaysStrictRegex : this._weekdaysRegex)
                    : (g(this, "_weekdaysRegex") || (this._weekdaysRegex = Wt),
        ...
        return (
            ...
            (x.weekdaysMin = function (e, t, n) {
                return Ye(e, t, n, "weekdaysMin");
            }),
            (x.defineLocale = oe),
            (x.updateLocale = function (e, t) {
                var n, i, r;
                return (
                    null != t
                        ? ((r = Xt),
            ...
            (x.weekdaysShort = function (e, t, n) {
                return Ye(e, t, n, "weekdaysShort");
            }),
            (x.normalizeUnits = D),
            (x.relativeTimeRounding = function (e) {
                return void 0 === e
                    ? In
                    : "function" == typeof e && ((In = e), !0);
            }),
            (x.relativeTimeThreshold = function (e, t) {
                return (
                    void 0 !== Yn[e] &&
                    (void 0 === t
                        ? Yn[e]
                                ...
                                return (function (e, t) {
                                    var n =
                                            1 < arguments.length && void 0 !== t
                                                ? t
                                                : {},
                                        i = Array.from(e.attributes).reduce(
                                            function (e, t) {
