...
class PaymentController extends Controller
{
    ...
    {
        $package = Package::all();
        return view('agency.customervisitorpages.payment.index',['packages'=>$package]);
    }
        ...
        if(!empty($exist_user)){
            ...
            if(!empty($exist_package) && !empty($remain_coins)){
                ...
                $checkout_session = \Stripe\Checkout\Session::create([
                    ...
                    'mode' => 'payment',
                    'success_url' => $YOUR_DOMAIN . '/customer/success/'.$id,
                    'cancel_url' => $YOUR_DOMAIN . '/customer/cancel',
                ]);
